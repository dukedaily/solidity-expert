...
export interface WorldCupV2 extends BaseContract {
  ...
  functions: {
    ...
    changeCount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    changeCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
