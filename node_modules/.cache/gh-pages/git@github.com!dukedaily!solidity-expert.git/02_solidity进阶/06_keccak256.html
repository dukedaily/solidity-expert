...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第6节:keccak256 · HonKit</title>
    ...
    <link rel="next" href="07_selector.html" />
    
    
    <link rel="prev" href="05_call&staticcall.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.7.6" data-path="06_keccak256.html">
        ...
        <a href=".." >第6节:keccak256</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第6节：keccak256哈希算法"><a name="第6节：keccak256哈希算法" class="plugin-anchor" href="#第6节：keccak256哈希算法"><i class="fa fa-link" aria-hidden="true"></i></a>第6节：keccak256哈希算法</h1>
<p>keccak256用于计算哈希，属于sha3算法，与sha256（属于sha2算法不同），keccak256使用场景如下：</p>
<ol>
<li>用于生成唯一id；</li>
<li>生成数据指纹；</li>
</ol>
...
contract HashFunction {
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">hash</span>(<span class="hljs-params">
        ...
        uint _num,
        address _addr
    </span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">returns</span> (<span class="hljs-params">bytes32</span>) </span>{
        <span class="hljs-keyword">return</span> keccak256(abi.encodePacked(_text, _num, _addr));
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">collision</span>(<span class="hljs-params">string memory _text, string memory _anotherText</span>)
        <span class="hljs-title">public</span>
        <span class="hljs-title">pure</span>
        <span class="hljs-title">returns</span> (<span class="hljs-params">bytes32</span>)
    </span>{
        <span class="hljs-comment">// encodePacked(AAA, BBB) -&gt; AAABBB</span>
        <span class="hljs-comment">// encodePacked(AA, ABBB) -&gt; AAABBB</span>
        <span class="hljs-keyword">return</span> keccak256(abi.encodePacked(_text, _anotherText));
    }
}
...
contract GuessTheMagicWord {
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">guess</span>(<span class="hljs-params">string memory _word</span>) <span class="hljs-title">public</span> <span class="hljs-title">view</span> <span class="hljs-title">returns</span> (<span class="hljs-params">bool</span>) </span>{
        <span class="hljs-keyword">return</span> keccak256(abi.encodePacked(_word)) == answer;
    }
}
</code></pre>
                ...
                <a href="05_call&staticcall.html" class="navigation navigation-prev " aria-label="Previous page: 第5节:call&staticcall">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="07_selector.html" class="navigation navigation-next " aria-label="Next page: 第7节:selector">
