...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第3节:payable · HonKit</title>
    ...
    <link rel="next" href="04_encode_encodePacked.html" />
    
    
    <link rel="prev" href="02_msg三人组.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.7.3" data-path="03_payable.html">
        ...
        <a href=".." >第3节:payable</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第3节：payable"><a name="第3节：payable" class="plugin-anchor" href="#第3节：payable"><i class="fa fa-link" aria-hidden="true"></i></a>第3节：payable</h1>
<ol>
<li>一个函数（或地址）如果想接收ether，需要将其修饰为：<strong>payable</strong>。</li>
<li>address常用方法：<ol>
<li>balance(): 查询当前地址的ether余额</li>
<li>transfer(uint): 合约向当前地址转指定数量的ether，如果失败会回滚</li>
<li>send(uint): 合约向当前地址转指定数量的ether，如果失败会返回false，不回滚（不建议使用send）</li>
</ol>
</li>
</ol>
...
contract Payable {
    <span class="hljs-comment">// 1. Payable address can receive Ether</span>
    address payable public owner;

    <span class="hljs-comment">// 2. Payable constructor can receive Ether</span>
    <span class="hljs-title">constructor</span>(<span class="hljs-params"></span>) <span class="hljs-title">payable</span> {
        owner = payable(msg.sender);
    }

    <span class="hljs-comment">// 3. Function to deposit Ether into this contract.</span>
    ...
    <span class="hljs-comment">// 4. Call this function along with some Ether.</span>
    <span class="hljs-comment">// The function will throw an error since this function is not payable.</span>
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">notPayable</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> </span>{}

    <span class="hljs-comment">// 5. Function to withdraw all Ether from this contract.</span>
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">withdraw</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> </span>{
        uint amount = address(<span class="hljs-built_in">this</span>).balance;
        owner.transfer(amount);
    }

    <span class="hljs-comment">// 6. Function to transfer Ether from this contract to address from input</span>
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">transfer</span>(<span class="hljs-params">address payable _to, uint _amount</span>) <span class="hljs-title">public</span> </span>{
        _to.transfer(_amount);
                ...
                <a href="02_msg三人组.html" class="navigation navigation-prev " aria-label="Previous page: 第2节:msg三人组">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="04_encode_encodePacked.html" class="navigation navigation-next " aria-label="Next page: 第4节:encode_encodePacked">
