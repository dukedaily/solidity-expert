...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第14节:try_catch · HonKit</title>
    ...
    <link rel="next" href="15_import.html" />
    
    
    <link rel="prev" href="13_delete.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.7.14" data-path="14_try_catch.html">
        ...
        <a href=".." >第14节:try_catch</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第14节：trycatch"><a name="第14节：trycatch" class="plugin-anchor" href="#第14节：trycatch"><i class="fa fa-link" aria-hidden="true"></i></a>第14节：try/catch</h1>
<p>try/catch仅可以捕捉在调用external函数或创建合约中抛出的异常信息。</p>
...
contract Foo {
    ...
    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params">address _owner</span>)</span> {
        <span class="hljs-built_in">require</span>(_owner != address(<span class="hljs-number">0</span>), <span class="hljs-string">&quot;invalid address&quot;</span>);
        assert(_owner != <span class="hljs-number">0x0000000000000000000000000000000000000001</span>);
        owner = _owner;
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">myFunc</span>(<span class="hljs-params">uint x</span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">returns</span> (<span class="hljs-params">string memory</span>) </span>{
...
contract Bar {
    ...
    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params"></span>)</span> {
        ...
        foo = <span class="hljs-keyword">new</span> Foo(msg.sender);
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">tryCatchExternalCall</span>(<span class="hljs-params">uint _i</span>) <span class="hljs-title">public</span> </span>{
        <span class="hljs-keyword">try</span> foo.myFunc(_i) returns (string memory result) {
            emit Log(result);
        } <span class="hljs-keyword">catch</span> {
            emit Log(<span class="hljs-string">&quot;external call failed&quot;</span>);
        }
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">tryCatchNewContract</span>(<span class="hljs-params">address _owner</span>) <span class="hljs-title">public</span> </span>{
        <span class="hljs-keyword">try</span> <span class="hljs-keyword">new</span> Foo(_owner) returns (Foo foo) {
            <span class="hljs-comment">// you can use variable foo here</span>
            emit Log(<span class="hljs-string">&quot;Foo created&quot;</span>);
        } <span class="hljs-keyword">catch</span> <span class="hljs-function"><span class="hljs-title">Error</span>(<span class="hljs-params">string memory reason</span>)</span> {
...
<p>没有错误信息的时候，直接使用catch比较稳妥，如果使用reason，会捕捉require发出的信息。</p>
                ...
                <a href="13_delete.html" class="navigation navigation-prev " aria-label="Previous page: 第13节:delete">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="15_import.html" class="navigation navigation-next " aria-label="Next page: 第15节:import">
