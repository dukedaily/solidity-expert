...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第15节:import · HonKit</title>
    ...
    <link rel="next" href="16_节约gas.html" />
    
    
    <link rel="prev" href="14_try_catch.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.7.15" data-path="15_import.html">
        ...
        <a href=".." >第15节:import</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第15节：import"><a name="第15节：import" class="plugin-anchor" href="#第15节：import"><i class="fa fa-link" aria-hidden="true"></i></a>第15节：import</h1>
<p>我们可以使用import将本地的.sol文件或外部（github或openzeppelin等）.sol导入进来</p>
<pre><code class="lang-js">├── Import.sol
└── Foo.sol
</code></pre>
<p>Fool.sol</p>
<p>常量、函数、枚举、结构体、Error可以定义在合约之外；事件、变量不允许定义在合约之外。</p>
...
<span class="hljs-comment">// 事件不允许定义在合约之外</span>
<span class="hljs-comment">// event Greeting(string);</span>

error Unauthorized(address caller);

string constant greeting = <span class="hljs-string">&quot;hell world&quot;</span>;

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">add</span>(<span class="hljs-params">uint x, uint y</span>) <span class="hljs-title">pure</span> <span class="hljs-title">returns</span> (<span class="hljs-params">uint</span>) </span>{
    <span class="hljs-keyword">return</span> x + y;
}

contract Foo {
    string public name = <span class="hljs-string">&quot;Foo&quot;</span>;
}
</code></pre>
<p>Import.sol</p>
<pre><code class="lang-js"><span class="hljs-comment">// SPDX-License-Identifier: MIT</span>
...
<span class="hljs-keyword">import</span> {Unauthorized, add <span class="hljs-keyword">as</span> func, Point} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./Foo.sol&quot;</span>;

contract Import {
    <span class="hljs-comment">// Initialize Foo.sol</span>
    Foo public foo = <span class="hljs-keyword">new</span> Foo();

    <span class="hljs-comment">// Test Foo.sol by getting it&apos;s name.</span>
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getFooName</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">view</span> <span class="hljs-title">returns</span> (<span class="hljs-params">string memory</span>) </span>{
        <span class="hljs-keyword">return</span> foo.name();
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">myAdd</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">returns</span>(<span class="hljs-params">uint</span>) </span>{
        <span class="hljs-keyword">return</span> func(<span class="hljs-number">1</span>,<span class="hljs-number">2</span>);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">greetingCall</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">returns</span>(<span class="hljs-params">string memory</span>) </span>{
        <span class="hljs-keyword">return</span> greeting;
    }
}
</code></pre>
<p>导入外部文件：</p>
<pre><code class="lang-js"><span class="hljs-comment">// https://github.com/owner/repo/blob/branch/path/to/Contract.sol</span>
...
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.5/contracts/utils/cryptography/ECDSA.sol&quot;</span>;
                ...
                <a href="14_try_catch.html" class="navigation navigation-prev " aria-label="Previous page: 第14节:try_catch">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="16_节约gas.html" class="navigation navigation-next " aria-label="Next page: 第16节:节约gas">
