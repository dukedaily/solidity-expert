...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第12节:new_create2 · HonKit</title>
    ...
    <link rel="next" href="13_delete.html" />
    
    
    <link rel="prev" href="11_合约间调用.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.7.12" data-path="12_new_create2.html">
        ...
        <a href=".." >第12节:new_create2</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第12节：new合约"><a name="第12节：new合约" class="plugin-anchor" href="#第12节：new合约"><i class="fa fa-link" aria-hidden="true"></i></a>第12节：new合约</h1>
<p>创建合约时，在世界状态中，增加一个地址与账户的信息。</p>
<p><img src="assets/image-20220906214046327.png" alt="image-20220906214046327"></p>
<p>在合约内部可以使用关键字<strong>new</strong>创建新的合约；</p>
<p>在0.8.0版本之后，new增加了salt选项，从而支持了create2的特性（通过salt可以计算出创建合约的地址）。</p>
...
contract Car {
    ...
    <span class="hljs-title">constructor</span>(<span class="hljs-params">address _owner, string memory _model</span>) <span class="hljs-title">payable</span> {
        owner = _owner;
        model = _model;
        carAddr = address(<span class="hljs-built_in">this</span>);
    }
}
...
contract CarFactory {
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">create</span>(<span class="hljs-params">address _owner, string memory _model</span>) <span class="hljs-title">public</span> </span>{
        Car car = <span class="hljs-keyword">new</span> Car(_owner, _model);
        cars.push(car);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">createAndSendEther</span>(<span class="hljs-params">address _owner, string memory _model</span>) <span class="hljs-title">public</span> <span class="hljs-title">payable</span> </span>{
        Car car = (<span class="hljs-keyword">new</span> Car){<span class="hljs-attr">value</span>: msg.value}(_owner, _model);
        cars.push(car);
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">create2</span>(<span class="hljs-params">
        ...
        Car car = (<span class="hljs-keyword">new</span> Car){<span class="hljs-attr">salt</span>: _salt}(_owner, _model);
        cars.push(car);
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">create2AndSendEther</span>(<span class="hljs-params">
        ...
        Car car = (<span class="hljs-keyword">new</span> Car){<span class="hljs-attr">value</span>: msg.value, <span class="hljs-attr">salt</span>: _salt}(_owner, _model);
        cars.push(car);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getCar</span>(<span class="hljs-params">uint _index</span>)
        ...
        <span class="hljs-keyword">return</span> (car.owner(), car.model(), car.carAddr(), address(car).balance);
    }
}
</code></pre>
                ...
                <a href="11_合约间调用.html" class="navigation navigation-prev " aria-label="Previous page: 第11节:合约间调用">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="13_delete.html" class="navigation navigation-next " aria-label="Next page: 第13节:delete">
