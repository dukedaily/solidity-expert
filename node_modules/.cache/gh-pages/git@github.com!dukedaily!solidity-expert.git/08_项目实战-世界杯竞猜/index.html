...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第八章:项目实战-世界杯竞猜 · HonKit</title>
    ...
    <link rel="next" href="docs/01_世界杯竞猜_solidity.html" />
    
    
    <link rel="prev" href="../07_subgraph/02_实战教程.html" />
...
<ul class="summary">
        ...
        <li class="chapter " data-level="1.13.1" data-path="docs/01_世界杯竞猜_solidity.html">
            
                <a href="docs/01_世界杯竞猜_solidity.html">
        ...
        <li class="chapter " data-level="1.13.2" data-path="docs/02_世界杯竞猜_hardhat.html">
            
                <a href="docs/02_世界杯竞猜_hardhat.html">
        ...
        <li class="chapter " data-level="1.13.3" data-path="docs/03_世界杯竞猜_ERC20.html">
            
                <a href="docs/03_世界杯竞猜_ERC20.html">
        ...
        <li class="chapter " data-level="1.13.4" data-path="docs/04_世界杯竞猜_subgraph.html">
            
                <a href="docs/04_世界杯竞猜_subgraph.html">
        ...
        <li class="chapter " data-level="1.13.5" data-path="docs/05-世界杯竞猜_airdrop.html">
            
                <a href="docs/05-世界杯竞猜_airdrop.html">
        ...
        <li class="chapter " data-level="1.13.6" data-path="docs/06_世界杯竞猜_upgrade.html">
            
                <a href="docs/06_世界杯竞猜_upgrade.html">
        ...
        <a href=".." >第八章:项目实战-世界杯竞猜</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第八章：世界杯竞猜（项目实战）"><a name="第八章：世界杯竞猜（项目实战）" class="plugin-anchor" href="#第八章：世界杯竞猜（项目实战）"><i class="fa fa-link" aria-hidden="true"></i></a>第八章：世界杯竞猜（项目实战）</h1>
<blockquote>
...
<p>前面介绍了很多语法内容，对solidity知识点进行了详细梳理，相信认真学习的同学已经掌握了基本的合约知识。</p>
<p>但是对于一个DAPP开发而言，这些知识点只是最基础的环节，我们需要一次项目实战，将整个知识体系串联起来，因此我开启了这个是：<strong>世界杯竞猜</strong> 实战项目。</p>
<p><img src="assets/主页.png" alt="主页"></p>
<p>本次课程内容来自于我的一次公司内部培训，我将培训内容进行二次整理后同步出来，供web3爱好者学习。</p>
<p>当前已经有第一个版本了（goerli网络），先睹为快：<a href="https://solidity-expert-worldcup.vercel.app/" target="_blank">https://solidity-expert-worldcup.vercel.app/</a></p>
<ul>
<li>任何人都可以：Play</li>
<li>管理员可以：Finalize</li>
<li>仁和园都可以领奖：ClaimReward（需要先Finalize）</li>
</ul>
<h2 id="dapp开发需要哪些技能？"><a name="dapp开发需要哪些技能？" class="plugin-anchor" href="#dapp开发需要哪些技能？"><i class="fa fa-link" aria-hidden="true"></i></a>DAPP开发需要哪些技能？</h2>
<ol>
...
<li><strong>sdk（optional）</strong>：主流的web3库为web3.js或ethers.js，所有与链上交互的操作都是通过这两个库进行的；</li>
<li><strong>Subgraph</strong>: 这是一个三方基建服务，可以在链下对事件进行捕捉（扫链、计算、存储postgres），从而对进行数据整合，被前端调用，快速返回数据，极大的方便了开发者。</li>
<li><strong>前端</strong>：react（大项目使用，知名协议原生支持的库更全面）</li>
<li><strong>后端</strong>（<strong>optional</strong>）：机器人、周期性调用合约、监听扫链（钱包）、其他需求</li>
</ol>
<h2 id="你能学到什么？"><a name="你能学到什么？" class="plugin-anchor" href="#你能学到什么？"><i class="fa fa-link" aria-hidden="true"></i></a>你能学到什么？</h2>
<p>我们通过不断增加功能需求，引入新的知识点，从而完成学习，开展形式和节奏如下：</p>
<p><strong>第一节：世界杯竞猜业务：</strong>主要讲solidity合约语法，在remix实现合约逻辑，并完成基本测试。</p>
<p><strong>第二节：工程化管理：</strong>介绍hardhat框架的使用，在框架中完成合约编译、部署、verify、单元测试等。</p>
<p><strong>第三节：Token协议：</strong>主要介绍token协议：ERC20、ERC721、ERC1155，后两者就是我们常说的NFT，从而为后续经济激励做铺垫。</p>
<p><strong>第四节：系统优化：</strong>学习subgraph，为系统的性能、功能做升级。</p>
<p><strong>第五节：后台服务：</strong>引入后台server，从而学习如何使用server调用合约。</p>
<p><strong>第六节：发放奖励：</strong>增加经济激励，完成奖励领取，学习Merkel tree相关知识。</p>
<p><strong>第七节：质押挖矿：</strong>学习staking相关知识点。</p>
<p><strong>第八节：链下授权：</strong>了解permit相关知识点，approve+transferFrom一笔完成。</p>
<p><strong>第九节：可升级合约：</strong>完成合约升级技能，数据业务分离。</p>
<p><strong>第十节：个人中心：</strong>与链下server结合，展示个人主页。</p>
<p>其他待定...（这个项目应该会一直维护，可以做很久）</p>
<h2 id="如何开展？"><a name="如何开展？" class="plugin-anchor" href="#如何开展？"><i class="fa fa-link" aria-hidden="true"></i></a>如何开展？</h2>
<p>第一阶段的课程会持续到年底，尽量保证每周能更新一次，开源内容安排如下：</p>
<ul>
<li>代码、课件会同步开源到github和公众号（README中有）；</li>
<li>视频需要二次录制，需要大量精力，这个视具体情况而定；</li>
<li>课程内容还在同步开发中，具体内容、顺序可能会有变化。</li>
</ul>
<h2 id="小结"><a name="小结" class="plugin-anchor" href="#小结"><i class="fa fa-link" aria-hidden="true"></i></a>小结</h2>
<p>学海无涯，Web3永驻，老夫载你一程！</p>
<hr>
...
<p>关于作者：国内第一批区块链布道者；2017年开始专注于区块链教育(btc, eth, fabric)，目前base新加坡，专注海外defi,dex,元宇宙等业务方向。</p>
                ...
                <a href="../07_subgraph/02_实战教程.html" class="navigation navigation-prev " aria-label="Previous page: 第2节:教程">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="docs/01_世界杯竞猜_solidity.html" class="navigation navigation-next " aria-label="Next page: 第1节:世界杯竞猜-solidity">
