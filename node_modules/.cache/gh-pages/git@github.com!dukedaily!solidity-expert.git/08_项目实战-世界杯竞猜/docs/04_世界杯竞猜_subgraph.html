...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第4节:世界杯竞猜_subgraph · HonKit</title>
    ...
    <link rel="next" href="05-世界杯竞猜_airdrop.html" />
    
    
    <link rel="prev" href="03_世界杯竞猜_ERC20.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.13.4" data-path="04_世界杯竞猜_subgraph.html">
        ...
        <a href="../.." >第4节:世界杯竞猜_subgraph</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第4节：世界杯竞猜（subgraph）"><a name="第4节：世界杯竞猜（subgraph）" class="plugin-anchor" href="#第4节：世界杯竞猜（subgraph）"><i class="fa fa-link" aria-hidden="true"></i></a>第4节：世界杯竞猜（subgraph）</h1>
<blockquote>
...
<p>subgraph是DAPP领域最重要的基建之一，主流协议都在使用，其功能为：</p>
<ul>
<li>链下监听事件，逻辑处理，存储到数据库中，供前端调用；</li>
<li>常用于：统计历史信息等，仅做展示相关，可以节约链上存储成本，且响应更快；</li>
<li>请求subgraph的时候使用<a href="https://thegraph.com/docs/en/querying/graphql-api/" target="_blank">graphql</a>语言，而非sql语句。</li>
</ul>
<p>下图的是uniswapV3的面板信息，其中绝大多数内容都取自subgraph服务。</p>
<p><img src="assets/image-20221006102831823.png" alt="image-20221006102831823"></p>
<h2 id="举例"><a name="举例" class="plugin-anchor" href="#举例"><i class="fa fa-link" aria-hidden="true"></i></a>举例</h2>
<ul>
<li><p>uniswap v3的<a href="https://info.uniswap.org/#/tokens" target="_blank">token功能</a>主要是从subgraph中读取的</p>
</li>
<li><p>问：uniswapV3 查询当前有哪些pool？</p>
</li>
<li><p>Url：<a href="https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v3" target="_blank">https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v3</a></p>
</li>
<li><p>请求语句：</p>
<pre><code class="lang-js">{
  <span class="hljs-function"><span class="hljs-title">pools</span>(<span class="hljs-params">
      first: <span class="hljs-number">50</span> 
      orderBy: totalValueLockedUSD 
      orderDirection: desc  
      subgraphError: allow</span>)</span> {    
      id    
      __typename  
    }
}
...
<pre><code class="lang-js">{
  <span class="hljs-string">&quot;data&quot;</span>: {
    <span class="hljs-string">&quot;pools&quot;</span>: [
      {
        <span class="hljs-string">&quot;id&quot;</span>: <span class="hljs-string">&quot;0x277667eb3e34f134adf870be9550e9f323d0dc24&quot;</span>,
        <span class="hljs-string">&quot;__typename&quot;</span>: <span class="hljs-string">&quot;Pool&quot;</span>
      },
      {
        <span class="hljs-string">&quot;id&quot;</span>: <span class="hljs-string">&quot;0xa850478adaace4c08fc61de44d8cf3b64f359bec&quot;</span>,
        <span class="hljs-string">&quot;__typename&quot;</span>: <span class="hljs-string">&quot;Pool&quot;</span>
      },
      {
        <span class="hljs-string">&quot;id&quot;</span>: <span class="hljs-string">&quot;0x8c0411f2ad5470a66cb2e9c64536cfb8dcd54d51&quot;</span>,
        <span class="hljs-string">&quot;__typename&quot;</span>: <span class="hljs-string">&quot;Pool&quot;</span>
      },
      {
        <span class="hljs-string">&quot;id&quot;</span>: <span class="hljs-string">&quot;0x055284a4ca6532ecc219ac06b577d540c686669d&quot;</span>,
        <span class="hljs-string">&quot;__typename&quot;</span>: <span class="hljs-string">&quot;Pool&quot;</span>
      }
     ]
  }
...
<h2 id="原理"><a name="原理" class="plugin-anchor" href="#原理"><i class="fa fa-link" aria-hidden="true"></i></a>原理</h2>
<ol>
<li>用户从合约侧发起交易；</li>
<li>合约发送事件；</li>
<li>由subgraph监听到该事件，并在内部执行逻辑（我们根据业务需求，自定义），处理后入库；</li>
<li>用户（前端）从subgraph的数据空中读取数据，完成展示。</li>
</ol>
<p><img src="assets/subgraph流程图.jpg" alt="subgraph流程图"></p>
<h2 id="可选资源"><a name="可选资源" class="plugin-anchor" href="#可选资源"><i class="fa fa-link" aria-hidden="true"></i></a>可选资源</h2>
<p>subgraph一共有三种模式可以使用，具体如下（我们使用第三种）：</p>
<ol>
<li>the graph官方提供的host serivce模式（<a href="https://thegraph.com/blog/sunsetting-hosted-service/" target="_blank">已经废弃了</a>）</li>
<li>the graph官方提供的去中心化网络：<a href="https://thegraph.com/docs/en/deploying/subgraph-studio/" target="_blank">subgraph studio</a>（需要token支持，激励别人帮忙加速索引，请自行尝试）</li>
<li>使用the graph官方提供的开源代码自己搭建：<strong>（推荐，<a href="https://thegraph.academy/developers/local-development/" target="_blank">官方指导</a>）</strong><ol>
<li>先试用docker创建一个：graph node</li>
<li>在graph node上部署subgraph</li>
</ol>
</li>
</ol>
<h2 id="关系梳理"><a name="关系梳理" class="plugin-anchor" href="#关系梳理"><i class="fa fa-link" aria-hidden="true"></i></a>关系梳理</h2>
<p>graph node和subgraph的关系如下，在graph node上可以部署多个subgraph，每个subgraph可以服务多个不同的项目。官方的host service（已经废弃），就是帮我们创建了一个graph node。</p>
<p><img src="assets/graphnode.jpg" alt="graphnode"></p>
<p>下面我们聊一聊如何进行使用docker搭建graphnode并部署自己的subgraph。</p>
<h2 id="创建subgraph"><a name="创建subgraph" class="plugin-anchor" href="#创建subgraph"><i class="fa fa-link" aria-hidden="true"></i></a>创建subgraph</h2>
<p>安装命令graph，用于创建subgraph项目，编译，部署等。</p>
<pre><code class="lang-sh"><span class="hljs-comment">#安装命令</span>
npm install -g  @graphprotocol/graph-cli
</code></pre>
<p>初始化项目</p>
<pre><code class="lang-sh">graph init
</code></pre>
<p>具体选项跟随引导程序填写，选择：网络-&gt; 名称-&gt; 合约地址 -&gt; 合约名字，引导程序会自动在网络上拉取ABI（前提是我们verify了，否则需要自己填写）</p>
<p><img src="assets/image-20221008181919484.png" alt="image-20221008181919484"></p>
<p>由于我们将自己搭建graphnode，而不是使用官方的host service，所以可以忽略Next Steps中提示的内容。</p>
<p>查看一下目录结构如下：</p>
<p><img src="assets/image-20221008182708149.png" alt="image-20221008182708149"></p>
<h2 id="业务改造"><a name="业务改造" class="plugin-anchor" href="#业务改造"><i class="fa fa-link" aria-hidden="true"></i></a>业务改造</h2>
<p>在配置文件中增加扫块起点<code>startBlock</code>，如果不增加，则从最初开始扫块，效率太低了。</p>
<p><img src="assets/image-20221008182827679.png" alt="image-20221008182827679"></p>
<h2 id="小结"><a name="小结" class="plugin-anchor" href="#小结"><i class="fa fa-link" aria-hidden="true"></i></a>小结</h2>
<p>到这里，我们已经介绍了subgraph的基本概念，并且完成了对subgraph的基本框架的搭建，下一节，我们将编写具体的业务逻辑，完成对世界杯玩家的激励。</p>
<hr>
...
<p>关于作者：国内第一批区块链布道者；2017年开始专注于区块链教育(btc, eth, fabric)，目前base新加坡，专注海外defi,dex,元宇宙等业务方向。</p>
                ...
                <a href="03_世界杯竞猜_ERC20.html" class="navigation navigation-prev " aria-label="Previous page: 第3节:世界杯竞猜-ERC20">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="05-世界杯竞猜_airdrop.html" class="navigation navigation-next " aria-label="Next page: 第5节:世界杯竞猜_airdrop">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第4节:世界杯竞猜_subgraph","level":"1.13.4","depth":2,"next":{"title":"第5节:世界杯竞猜_airdrop","level":"1.13.5","depth":2,"path":"08_项目实战-世界杯竞猜/docs/05-世界杯竞猜_airdrop.md","ref":"08_项目实战-世界杯竞猜/docs/05-世界杯竞猜_airdrop.md","articles":[]},"previous":{"title":"第3节:世界杯竞猜-ERC20","level":"1.13.3","depth":2,"path":"08_项目实战-世界杯竞猜/docs/03_世界杯竞猜_ERC20.md","ref":"08_项目实战-世界杯竞猜/docs/03_世界杯竞猜_ERC20.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"08_项目实战-世界杯竞猜/docs/04_世界杯竞猜_subgraph.md","mtime":"2022-11-03T12:07:16.566Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"../..","book":{"language":""}});
        });
    </script>
</div>
