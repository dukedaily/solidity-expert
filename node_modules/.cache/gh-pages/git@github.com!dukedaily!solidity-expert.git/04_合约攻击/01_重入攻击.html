...
<html lang="" >
    ...
    <link rel="next" href="02_返回值校验.html" />
    
    
    <link rel="prev" href="00_智能合约编写一般原则.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.9.2" data-path="01_重入攻击.html">
        ...
        <a href=".." >第1节:重入攻击</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第1节：重入攻击（re-entry）"><a name="第1节：重入攻击（re-entry）" class="plugin-anchor" href="#第1节：重入攻击（re-entry）"><i class="fa fa-link" aria-hidden="true"></i></a>第1节：重入攻击（Re-entry）</h1>
<p>假设：我们在A合约中调用B合约的方法</p>
<p>重入攻击是指：A合约调用B（恶意合约）结束之前，B（恶意合约）内的函数反向调用A（原合约）的函数实现的攻击。</p>
<p>以下案例是在使用call进行ether转账时，在fallback函数中再次调用了call转账，从而实现攻击效果。</p>
...
contract EtherStore {
    mapping(<span class="hljs-function"><span class="hljs-params">address</span> =&gt;</span> uint) public balances;
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">withdraw</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> </span>{
        ...
        (bool sent, ) = msg.sender.call{<span class="hljs-attr">value</span>: bal}(<span class="hljs-string">&quot;&quot;</span>);
...
contract Attack {
    ...
    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params">address _etherStoreAddress</span>)</span> {
        etherStore = EtherStore(_etherStoreAddress);
    }

    <span class="hljs-comment">// Fallback is called when EtherStore sends Ether to this contract.</span>
    fallback() external payable {
        <span class="hljs-keyword">if</span> (address(etherStore).balance &gt;= <span class="hljs-number">1</span> ether) {
            etherStore.withdraw();
        }
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">attack</span>(<span class="hljs-params"></span>) <span class="hljs-title">external</span> <span class="hljs-title">payable</span> </span>{
        <span class="hljs-built_in">require</span>(msg.value &gt;= <span class="hljs-number">1</span> ether);
        etherStore.deposit{<span class="hljs-attr">value</span>: <span class="hljs-number">1</span> ether}();
        etherStore.withdraw();
    }
...
<p>解决办法：</p>
<ol>
<li><p>在调用外部合约之前，优先更新状态变量；</p>
<pre><code class="lang-js">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">withdraw</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> </span>{
        uint bal = balances[msg.sender];
        <span class="hljs-built_in">require</span>(bal &gt; <span class="hljs-number">0</span>);

          balances[msg.sender] = <span class="hljs-number">0</span>;  <span class="hljs-comment">//&lt;&lt;&lt;=== 提前修改状态变量</span>
...
contract ReEntrancyGuard {
    ...
    modifier <span class="hljs-function"><span class="hljs-title">noReentrant</span>(<span class="hljs-params"></span>)</span> {
...
contract EtherStore is ReEntrancyGuard {
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">withdraw</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">noReentrant</span> </span>{ <span class="hljs-comment">//&lt;&lt;&lt;=== 增加修饰器</span>
        uint bal = balances[msg.sender];
        <span class="hljs-built_in">require</span>(bal &gt; <span class="hljs-number">0</span>);
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getBalance</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">view</span> <span class="hljs-title">returns</span> (<span class="hljs-params">uint</span>) </span>{
        <span class="hljs-keyword">return</span> address(<span class="hljs-built_in">this</span>).balance;
                ...
                <a href="00_智能合约编写一般原则.html" class="navigation navigation-prev " aria-label="Previous page: 第0节:智能合约编写一般原则">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="02_返回值校验.html" class="navigation navigation-next " aria-label="Next page: 第2节:返回值校验">
