...
<html lang="" >
    ...
    <link rel="next" href="04_读取私有变量.html" />
    
    
    <link rel="prev" href="02_返回值校验.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.9.4" data-path="03_合约自杀.html">
        ...
        <a href=".." >第3节:合约自杀</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第3节：self-destruct"><a name="第3节：self-destruct" class="plugin-anchor" href="#第3节：self-destruct"><i class="fa fa-link" aria-hidden="true"></i></a>第3节：Self Destruct</h1>
<p>合约自杀时，会将合约自身持有的ether全部转入到指定地址之中。</p>
...
contract EtherGame {
    uint public targetAmount = <span class="hljs-number">7</span> ether;
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">deposit</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">payable</span> </span>{
        <span class="hljs-built_in">require</span>(msg.value == <span class="hljs-number">1</span> ether, <span class="hljs-string">&quot;You can only send 1 Ether&quot;</span>);

        uint balance = address(<span class="hljs-built_in">this</span>).balance;
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">claimReward</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> </span>{
        <span class="hljs-built_in">require</span>(msg.sender == winner, <span class="hljs-string">&quot;Not winner&quot;</span>);

        (bool sent, ) = msg.sender.call{<span class="hljs-attr">value</span>: address(<span class="hljs-built_in">this</span>).balance}(<span class="hljs-string">&quot;&quot;</span>);
...
contract Attack {
    ...
    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params">EtherGame _etherGame</span>)</span> {
        etherGame = EtherGame(_etherGame);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">attack</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">payable</span> </span>{
...
<p>解决方案：</p>
<p>不要依赖address(this).balance来进行校验</p>
<pre><code class="lang-js"><span class="hljs-comment">// SPDX-License-Identifier: MIT</span>
pragma solidity ^<span class="hljs-number">0.8</span><span class="hljs-number">.13</span>;

contract EtherGame {
    uint public targetAmount = <span class="hljs-number">3</span> ether;
    uint public balance;
    address public winner;
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">deposit</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">payable</span> </span>{
        ...
        balance += msg.value; <span class="hljs-comment">//&lt;&lt;== 通过状态变量来统计ether，此时及时合约自杀传入ether，也不会干扰条件判断逻辑。</span>
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">claimReward</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> </span>{
        ...
        (bool sent, ) = msg.sender.call{<span class="hljs-attr">value</span>: balance}(<span class="hljs-string">&quot;&quot;</span>);
        <span class="hljs-built_in">require</span>(sent, <span class="hljs-string">&quot;Failed to send Ether&quot;</span>);
    }
}
</code></pre>
                ...
                <a href="02_返回值校验.html" class="navigation navigation-prev " aria-label="Previous page: 第2节:返回值校验">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="04_读取私有变量.html" class="navigation navigation-next " aria-label="Next page: 第4节:读取私有变量">
