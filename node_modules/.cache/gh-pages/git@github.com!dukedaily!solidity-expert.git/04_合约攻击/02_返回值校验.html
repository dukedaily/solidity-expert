...
<html lang="" >
    ...
    <link rel="next" href="03_合约自杀.html" />
    
    
    <link rel="prev" href="01_重入攻击.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.9.3" data-path="02_返回值校验.html">
        ...
        <a href=".." >第2节:返回值校验</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第2节：返回值校验"><a name="第2节：返回值校验" class="plugin-anchor" href="#第2节：返回值校验"><i class="fa fa-link" aria-hidden="true"></i></a>第2节：返回值校验</h1>
<p>调用外部合约函数时，有些函数调用失败不会抛出错误回滚交易而是返回 <strong>false</strong>，如果忘记检查函数返回值会导致误以为调用成功。</p>
...
<p>当使用call方法调用approve时，如果没有校验返回值，则即使失败，也不会抛出异常。</p>
                ...
                <a href="01_重入攻击.html" class="navigation navigation-prev " aria-label="Previous page: 第1节:重入攻击">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="03_合约自杀.html" class="navigation navigation-next " aria-label="Next page: 第3节:合约自杀">
