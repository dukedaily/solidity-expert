...
<html lang="" >
    ...
    <link rel="next" href="05_安全尝试.html" />
    
    
    <link rel="prev" href="03_合约自杀.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.9.5" data-path="04_读取私有变量.html">
        ...
        <a href=".." >第4节:读取私有变量</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第4节：访问私有数据private-data"><a name="第4节：访问私有数据private-data" class="plugin-anchor" href="#第4节：访问私有数据private-data"><i class="fa fa-link" aria-hidden="true"></i></a>第4节：访问私有数据Private Data</h1>
<p>所有链上的数据都可以被访问；不要把任何敏感信息存储在链上</p>
...
contract Vault {
    ...
    uint public count = <span class="hljs-number">123</span>;
    <span class="hljs-comment">// slot 1</span>
    address public owner = msg.sender;
    bool public isTrue = <span class="hljs-literal">true</span>;
    uint16 public u16 = <span class="hljs-number">31</span>;
    <span class="hljs-comment">// slot 2</span>
    bytes32 private password;

    <span class="hljs-comment">// constants do not use storage</span>
    uint public constant someConst = <span class="hljs-number">123</span>;

    <span class="hljs-comment">// slot 3, 4, 5 (one for each array element)</span>
    bytes32[<span class="hljs-number">3</span>] public data;
    ...
    mapping(<span class="hljs-function"><span class="hljs-params">uint</span> =&gt;</span> User) private idToUser;

    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params">bytes32 _password</span>)</span> {
        password = _password;
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">addUser</span>(<span class="hljs-params">bytes32 _password</span>) <span class="hljs-title">public</span> </span>{
        User memory user = User({<span class="hljs-attr">id</span>: users.length, <span class="hljs-attr">password</span>: _password});
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getArrayLocation</span>(<span class="hljs-params">
        ...
        uint index,
        uint elementSize
    </span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">returns</span> (<span class="hljs-params">uint</span>) </span>{
        <span class="hljs-keyword">return</span> uint(keccak256(abi.encodePacked(slot))) + (index * elementSize);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getMapLocation</span>(<span class="hljs-params">uint slot, uint key</span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">returns</span> (<span class="hljs-params">uint</span>) </span>{
        <span class="hljs-keyword">return</span> uint(keccak256(abi.encodePacked(key, slot)));
    }
}
...
<p>在线验证：<a href="https://web3playground.io/QmQgatm8kvy3QcWugTTiegiAz8mnqLkaXGRRu37yX1ucFq" target="_blank">https://web3playground.io/QmQgatm8kvy3QcWugTTiegiAz8mnqLkaXGRRu37yX1ucFq</a></p>
                ...
                <a href="03_合约自杀.html" class="navigation navigation-prev " aria-label="Previous page: 第3节:合约自杀">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="05_安全尝试.html" class="navigation navigation-next " aria-label="Next page: 第5节:安全尝试">
