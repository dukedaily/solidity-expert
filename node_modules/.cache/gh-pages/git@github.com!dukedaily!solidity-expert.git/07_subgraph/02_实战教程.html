...
<html lang="" >
    ...
    <link rel="next" href="../08_项目实战-世界杯竞猜/" />
    
    
    <link rel="prev" href="01_概述.html" />
...
<ul class="summary">
        ...
        <li class="chapter " data-level="1.12.1" data-path="01_概述.html">
        ...
        <li class="chapter active" data-level="1.12.2" data-path="02_实战教程.html">
        ...
        <a href=".." >第2节:教程</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第2节：subgraph实现dapp实战教程"><a name="第2节：subgraph实现dapp实战教程" class="plugin-anchor" href="#第2节：subgraph实现dapp实战教程"><i class="fa fa-link" aria-hidden="true"></i></a>第2节：subgraph实现dapp实战教程</h1>
<blockquote>
...
<p>通过学习本文，将全面掌握如何搭建graphnode，创建部署subgraph，以及如何与合约前端结合展示，通过一个完整的dapp案例，展示dapp开发的全部流程</p>
<ul>
<li><p>本文代码：<a href="https://github.com/dukedaily/subgraph-demo" target="_blank">https://github.com/dukedaily/subgraph-demo</a></p>
</li>
<li><p>本文视频：录制中⏺️</p>
</li>
<li><p>效果展示：<a href="https://dukedaily.github.io/subgraph-demo-dapp（需要先下载代码，本地运行docker-compose" target="_blank">https://dukedaily.github.io/subgraph-demo-dapp（需要先下载代码，本地运行docker-compose</a> up）</p>
<p><img src="assets/image-5022356.png" alt="image"></p>
</li>
</ul>
<h2 id="1-下载代码"><a name="1-下载代码" class="plugin-anchor" href="#1-下载代码"><i class="fa fa-link" aria-hidden="true"></i></a>1. 下载代码</h2>
<pre><code class="lang-sh">git <span class="hljs-built_in">clone</span> git@github.com:dukedaily/subgraph-demo-dapp.git
</code></pre>
<h2 id="2-部署合约"><a name="2-部署合约" class="plugin-anchor" href="#2-部署合约"><i class="fa fa-link" aria-hidden="true"></i></a>2. 部署合约</h2>
<pre><code class="lang-Bash"><span class="hljs-comment"># 进入合约目录</span>
<span class="hljs-built_in">cd</span> subgraph-demo-dapp/contracts

<span class="hljs-comment"># 配置.env信息</span>
ETHERSCAN_API_KEY=<span class="hljs-string">&apos;&apos;</span>
ALCHEMY_KEY=<span class="hljs-string">&apos;&apos;</span>
INFURA_KEY=<span class="hljs-string">&apos;&apos;</span>

MNEMONIC=<span class="hljs-string">&apos;&apos;</span>
...
<span class="hljs-comment"># 部署：address: 0x48d2825f3238db40797dF659C97188d289401311</span>
...
<h2 id="3-配置subgraph"><a name="3-配置subgraph" class="plugin-anchor" href="#3-配置subgraph"><i class="fa fa-link" aria-hidden="true"></i></a>3. 配置subgraph</h2>
<p>请查看具体文件：</p>
<pre><code class="lang-sh"><span class="hljs-comment"># 三个文件的关系：</span>
...
<h2 id="4-启动graphnode（docker）"><a name="4-启动graphnode（docker）" class="plugin-anchor" href="#4-启动graphnode（docker）"><i class="fa fa-link" aria-hidden="true"></i></a>4. 启动graphnode（docker）</h2>
<pre><code class="lang-sh"><span class="hljs-comment"># 先修改监听的网络rpc: ethereum: &apos;goerli:https://ethereum-goerli-rpc.allthatnode.com&apos;</span>

<span class="hljs-comment"># 确保docker已经启动</span>
docker-compose up
</code></pre>
<h2 id="5-创建subgraph（本地）"><a name="5-创建subgraph（本地）" class="plugin-anchor" href="#5-创建subgraph（本地）"><i class="fa fa-link" aria-hidden="true"></i></a>5. 创建subgraph（本地）</h2>
<pre><code class="lang-sh"><span class="hljs-comment"># 先创建subgraph</span>
yarn create-local

<span class="hljs-comment"># 后部署</span>
yarn deploy-local
</code></pre>
<p><img src="assets/image-20220519221014419.png" alt="image-20220519221014419"></p>
<h2 id="6-测试一下效果"><a name="6-测试一下效果" class="plugin-anchor" href="#6-测试一下效果"><i class="fa fa-link" aria-hidden="true"></i></a>6. 测试一下效果</h2>
<p>url：<a href="http://127.0.0.1:8000/subgraphs/name/dukedaily/example-subgraph/graphql" target="_blank">http://127.0.0.1:8000/subgraphs/name/dukedaily/example-subgraph/graphql</a></p>
...
<p>执行请求成功！</p>
<p><img src="assets/image-20220519221147734.png" alt="image-20220519221147734"></p>
<h2 id="7-准备前端"><a name="7-准备前端" class="plugin-anchor" href="#7-准备前端"><i class="fa fa-link" aria-hidden="true"></i></a>7. 准备前端</h2>
<p>进入到dapp文件夹，修改内容如下：</p>
<pre><code class="lang-sh"><span class="hljs-comment">#echo &quot;REACT_APP_GRAPHQL_ENDPOINT=http://localhost:8000/subgraphs/name/&lt;GITHUB_USERNAME&gt;/example-subgraph&quot; &gt; .env</span>

REACT_APP_GRAPHQL_ENDPOINT=http://127.0.0.1:8000/subgraphs/name/dukedaily/subgraph-demo
</code></pre>
<p>启动前端</p>
<pre><code class="lang-sh">yarn install  <span class="hljs-comment"># global VPN mode</span>
yarn start
</code></pre>
<h2 id="8-安装有问题（可选）"><a name="8-安装有问题（可选）" class="plugin-anchor" href="#8-安装有问题（可选）"><i class="fa fa-link" aria-hidden="true"></i></a>8. 安装有问题（可选）</h2>
<pre><code class="lang-sh"><span class="hljs-comment"># 删除文件</span>
rm -rf yarn.lock

<span class="hljs-comment"># 安装nvm，安装后需要配置文件，请仔细查看打印的log，有指导</span>
brew install nvm

<span class="hljs-comment"># 切换node版本，版本查询：https://www.npmjs.com/package/node</span>
...
<h2 id="9-查看效果"><a name="9-查看效果" class="plugin-anchor" href="#9-查看效果"><i class="fa fa-link" aria-hidden="true"></i></a>9. 查看效果</h2>
<p>效果如下，切换Order By可以调整展示顺序，由于网络问题，图片没能正常展示，可以在代码中自行替换。</p>
...
<p>关于作者：国内第一批区块链布道者；2017年开始专注于区块链教育(btc, eth, fabric)，目前base新加坡，专注海外defi,dex,元宇宙等业务方向。</p>
                ...
                <a href="01_概述.html" class="navigation navigation-prev " aria-label="Previous page: 第1节:概述">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="../08_项目实战-世界杯竞猜/" class="navigation navigation-next " aria-label="Next page: 第八章:项目实战-世界杯竞猜">
