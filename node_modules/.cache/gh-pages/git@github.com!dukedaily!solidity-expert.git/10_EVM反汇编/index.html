...
<html lang="" >
    ...
    <link rel="next" href="01_反汇编初步了解.html" />
    
    
    <link rel="prev" href="../09_EVM详解/03-汇编概述.html" />
        ...
        <a href=".." >第十章:EVM反汇编</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <p>工具：<a href="https://www.ethervm.io/decompile" target="_blank">https://www.ethervm.io/decompile</a></p>
<p><a href="https://github.com/Arachnid/evmdis" target="_blank">https://github.com/Arachnid/evmdis</a></p>
<h2 id="反汇编系列文章"><a name="反汇编系列文章" class="plugin-anchor" href="#反汇编系列文章"><i class="fa fa-link" aria-hidden="true"></i></a>反汇编系列文章</h2>
<ol>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-smart-contracts-392fdadef32d" target="_blank"><strong><em>Reversing and debugging EVM Smart contracts: First steps in assembly\</em> (part</strong> </a><strong>1️⃣</strong><a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-smart-contracts-392fdadef32d" target="_blank"><strong>)</strong></a></li>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-smart-contracts-part-2-e6106b9983a" target="_blank"><em>Reversing and debugging EVM Smart contracts: Deployment of a smart contract</em> <strong><em>(Part\</em></strong> </a>2️⃣<a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-smart-contracts-part-2-e6106b9983a" target="_blank"><strong><em>)\</em></strong></a></li>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-ethereum-evm-smart-contracts-part-3-ebe032a08f97" target="_blank"><em>Reversing and debugging EVM Smart contracts: How the storage layout works?</em> <strong><em>(part\</em></strong> </a>3️⃣<a href="https://medium.com/@TrustChain/reversing-and-debugging-ethereum-evm-smart-contracts-part-3-ebe032a08f97" target="_blank"><strong><em>)\</em></strong></a></li>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-the-end-of-time-part-4-3eafe5b0511a" target="_blank"><em>Reversing and Debugging EVM Smart contracts: 5 Instructions to end/abort the Execution</em> <strong><em>(part\</em></strong> </a>4️⃣<a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-the-end-of-time-part-4-3eafe5b0511a" target="_blank"><strong><em>)\</em></strong></a></li>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-the-execution-flow-part-5-2ffc97ef0b77" target="_blank"><em>Reversing and debugging EVM Smart contracts: The Execution flow if/else/for/functions</em> <strong><em>(part\</em></strong> </a>5️⃣<a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-the-execution-flow-part-5-2ffc97ef0b77" target="_blank"><strong><em>)\</em></strong></a></li>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-part-6-full-smart-contract-layout-f236c3121bd1" target="_blank"><em>Reversing and debugging EVM Smart contracts: Full Smart Contract layout</em> <strong><em>(part\</em></strong> </a>6️⃣<a href="https://medium.com/@TrustChain/reversing-and-debugging-part-6-full-smart-contract-layout-f236c3121bd1" target="_blank"><strong><em>)\</em></strong></a></li>
<li><a href="https://medium.com/@TrustChain/reversing-and-debugging-the-evm-part-7-2a20a44a555e" target="_blank"><em>Reversing and debugging EVM Smart contracts: External Calls and contract deployment</em> <strong>(part</strong> 7️⃣<strong>)</strong></a></li>
</ol>
<h2 id="计算方法的sig"><a name="计算方法的sig" class="plugin-anchor" href="#计算方法的sig"><i class="fa fa-link" aria-hidden="true"></i></a>计算方法的sig</h2>
<p><a href="https://web3playground.io/" target="_blank">https://web3playground.io/</a></p>
<pre><code class="lang-js"> <span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">main</span>(<span class="hljs-params"></span>) </span>{
   ...
   <span class="hljs-comment">//should be: 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef</span>
   ...
   <span class="hljs-keyword">let</span> transferFun = <span class="hljs-string">&quot;test()&quot;</span>
   ...
   <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&apos;Function sig:&apos;</span>, sig3)
                ...
                <a href="../09_EVM详解/03-汇编概述.html" class="navigation navigation-prev " aria-label="Previous page: 第3节:汇编概述">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="01_反汇编初步了解.html" class="navigation navigation-next " aria-label="Next page: 第1节:反汇编初步了解">
