...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第2节:合约部署都做了啥 · HonKit</title>
    ...
    <link rel="next" href="03_各种类型是如何存储的.html" />
    
    
    <link rel="prev" href="01_反汇编初步了解.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.15.2" data-path="02_合约部署都做了啥.html">
        ...
        <a href=".." >第2节:合约部署都做了啥</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第2节：合约部署"><a name="第2节：合约部署" class="plugin-anchor" href="#第2节：合约部署"><i class="fa fa-link" aria-hidden="true"></i></a>第2节：合约部署</h1>
<p><a href="https://medium.com/@TrustChain/reversing-and-debugging-evm-smart-contracts-part-2-e6106b9983a" target="_blank">Reversing and debugging EVM Smart contracts: Deployment of a smart contract-part2</a></p>
<h2 id="无payable"><a name="无payable" class="plugin-anchor" href="#无payable"><i class="fa fa-link" aria-hidden="true"></i></a>无payable</h2>
<pre><code class="lang-js">pragma solidity ^<span class="hljs-number">0.8</span><span class="hljs-number">.0</span>;  
contract Test {      
    uint balance;      
    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params"></span>)</span> {         
        balance = <span class="hljs-number">9</span>;     
    } 
}
</code></pre>
<p>EVM中，存储相关一共有三个区域：</p>
<ol>
<li>stack</li>
<li>memory</li>
<li>storage</li>
</ol>
<p>在执行构造函数之前，依然会做前置校验：msg.value等</p>
<p>涉及到构造函数的部分，主要是使用了SSTORE，将balance = 9存储到storage中，然后退出</p>
<p>中间比较含糊的是memory的地址问题，需要进一步理解（先忽略）</p>
<h2 id="有payable"><a name="有payable" class="plugin-anchor" href="#有payable"><i class="fa fa-link" aria-hidden="true"></i></a>有payable</h2>
<pre><code class="lang-js">pragma solidity ^<span class="hljs-number">0.8</span><span class="hljs-number">.0</span>;  
contract Test {      
    uint balance;      
...
<ol>
<li>opcode中，缺少了对msg.value校验对逻辑，因为已经不需要限定为0了</li>
<li>所以加上payable后opcode对size变小了，部署需要的gas也变少了</li>
</ol>
<h2 id="增加参数"><a name="增加参数" class="plugin-anchor" href="#增加参数"><i class="fa fa-link" aria-hidden="true"></i></a>增加参数</h2>
<pre><code class="lang-js">pragma solidity ^<span class="hljs-number">0.8</span><span class="hljs-number">.0</span>;  
    contract Test {       
        uint balance;      
        <span class="hljs-title">constructor</span>(<span class="hljs-params">uint a,uint b</span>) <span class="hljs-title">payable</span> { 
            balance = <span class="hljs-number">9</span>;     
    } 
}
</code></pre>
<ul>
<li>配合使用CODESIZE, CODECOPY, 将参数拷贝到内存中；（1，2）</li>
<li>data字段是bytecode，evm会按照逻辑解析，并执行bytecode，这是指令</li>
<li>验证参数个数，确定是2个，否则revert</li>
</ul>
<h2 id="总结"><a name="总结" class="plugin-anchor" href="#总结"><i class="fa fa-link" aria-hidden="true"></i></a>总结</h2>
<ol>
<li>It stores the free memory pointer as every smart contract does.</li>
<li>It copies the 2 arguments provided by transaction data and store them to memory.</li>
<li>It verifies that we entered at least 2 arguments in the constructor. (not less)</li>
<li>It copies the 2 arguments in memory in to the stack.</li>
<li>It executes the constructor by setting balance to 9.</li>
<li>It copies the code into memory and stop the execution.</li>
</ol>
<h2 id="tips"><a name="tips" class="plugin-anchor" href="#tips"><i class="fa fa-link" aria-hidden="true"></i></a>Tips</h2>
<ul>
<li>Every solidity smart contracts starts by mstore(0x40,0x80), which is 0x6080604052 in hex.</li>
</ul>
                ...
                <a href="01_反汇编初步了解.html" class="navigation navigation-prev " aria-label="Previous page: 第1节:反汇编初步了解">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="03_各种类型是如何存储的.html" class="navigation navigation-next " aria-label="Next page: 第3节:各种类型是如何存储的">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第2节:合约部署都做了啥","level":"1.15.2","depth":2,"next":{"title":"第3节:各种类型是如何存储的","level":"1.15.3","depth":2,"path":"10_EVM反汇编/03_各种类型是如何存储的.md","ref":"10_EVM反汇编/03_各种类型是如何存储的.md","articles":[]},"previous":{"title":"第1节:反汇编初步了解","level":"1.15.1","depth":2,"path":"10_EVM反汇编/01_反汇编初步了解.md","ref":"10_EVM反汇编/01_反汇编初步了解.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"10_EVM反汇编/02_合约部署都做了啥.md","mtime":"2022-11-03T12:07:16.529Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
