...
<html lang="" >
    ...
    <link rel="next" href="../07_subgraph/" />
    
    
    <link rel="prev" href="../05_hardhat框架/08_合约升级.html" />
        ...
        <a href=".." >第六章:ethers</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第六章：ethers库"><a name="第六章：ethers库" class="plugin-anchor" href="#第六章：ethers库"><i class="fa fa-link" aria-hidden="true"></i></a>第六章：ethers库</h1>
<p>ethers.js是一个轻量级的以太坊sdk，目前在很多场合已经替换web3.js，使用ethers可以方便的与以太坊网络进行交互，包括：部署合约、调用合约、钱包相关、utils等
包括主流快拦下hardhat也默认与ethers进行集成。</p>
<ul>
<li>手册：<a href="https://docs.ethers.io/v5/" target="_blank">https://docs.ethers.io/v5/</a></li>
<li>ethersjs学习1：<a href="https://github.com/WTFAcademy/WTF-Ethers" target="_blank">https://github.com/WTFAcademy/WTF-Ethers</a></li>
<li>ethersjs学习2：<a href="https://www.youtube.com/watch?v=yk7nVp5HTCk" target="_blank">https://www.youtube.com/watch?v=yk7nVp5HTCk</a></li>
</ul>
<p>// 进行中...</p>
                ...
                <a href="../05_hardhat框架/08_合约升级.html" class="navigation navigation-prev " aria-label="Previous page: 第8节:合约升级">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="../07_subgraph/" class="navigation navigation-next " aria-label="Next page: 第七章:subgraph">
