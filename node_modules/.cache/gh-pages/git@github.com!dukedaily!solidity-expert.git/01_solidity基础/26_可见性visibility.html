...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第26节:可见性visibility · HonKit</title>
    ...
    <link rel="next" href="27_abstract.html" />
    
    
    <link rel="prev" href="25_构造函数.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.6.26" data-path="26_可见性visibility.html">
        ...
        <a href=".." >第26节:可见性visibility</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第26节：可见性visibility"><a name="第26节：可见性visibility" class="plugin-anchor" href="#第26节：可见性visibility"><i class="fa fa-link" aria-hidden="true"></i></a>第26节：可见性visibility</h1>
<p>合约的方法和状态变量需要使用关键字进行修饰，从而决定其是否可以被其他合约调用，修饰符包括：</p>
<ul>
<li>public：所有的合约和外部账户（EOA）都可以调用；</li>
<li>private：只允许合约内部调用；</li>
<li>internal：仅允许合约内部以及子合约中调用；</li>
<li>external：仅允许外部地址(EOA或CA)调用，合约内部及子合约都不能调用；(早期版本可以使用this调用external方法)</li>
</ul>
<p>另，状态变量可以被修饰为：publi, private, internal，但是无法修饰为external</p>
...
contract Base {
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">testInternalFunc</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">virtual</span> <span class="hljs-title">returns</span> (<span class="hljs-params">string memory</span>) </span>{
    ...
    string private privateVar = <span class="hljs-string">&quot;my private variable&quot;</span>;
    string internal internalVar = <span class="hljs-string">&quot;my internal variable&quot;</span>;
    string public publicVar = <span class="hljs-string">&quot;my public variable&quot;</span>;
...
contract Child is Base {
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">testInternalFunc</span>(<span class="hljs-params"></span>) <span class="hljs-title">public</span> <span class="hljs-title">pure</span> <span class="hljs-title">override</span> <span class="hljs-title">returns</span> (<span class="hljs-params">string memory</span>) </span>{
        <span class="hljs-keyword">return</span> internalFunc();
    }
}
</code></pre>
                ...
                <a href="25_构造函数.html" class="navigation navigation-prev " aria-label="Previous page: 第25节:构造函数">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="27_abstract.html" class="navigation navigation-next " aria-label="Next page: 第27节:abstract">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第26节:可见性visibility","level":"1.6.26","depth":2,"next":{"title":"第27节:abstract","level":"1.6.27","depth":2,"path":"01_solidity基础/27_abstract.md","ref":"01_solidity基础/27_abstract.md","articles":[]},"previous":{"title":"第25节:构造函数","level":"1.6.25","depth":2,"path":"01_solidity基础/25_构造函数.md","ref":"01_solidity基础/25_构造函数.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"01_solidity基础/26_可见性visibility.md","mtime":"2022-11-09T00:23:06.709Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
