...
<html lang="" >
    ...
    <link rel="next" href="05_ERC1820.html" />
    
    
    <link rel="prev" href="03_ERC1155.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.8.4" data-path="04_ERC165.html">
        ...
        <a href=".." >第4节:ERC165</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第4节语法-erc165"><a name="第4节语法-erc165" class="plugin-anchor" href="#第4节语法-erc165"><i class="fa fa-link" aria-hidden="true"></i></a>第4节:语法-ERC165</h1>
<ol>
<li>没看到interfaceId在哪里定义了，目前没有找到（这个值哪来的？）</li>
<li>没见到supportsInterface在哪里被调用（如何使用）</li>
</ol>
<pre><code class="lang-js">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">supportsInterface</span>(<span class="hljs-params">bytes4 interfaceId</span>) <span class="hljs-title">public</span> <span class="hljs-title">view</span> <span class="hljs-title">virtual</span> <span class="hljs-title">override</span>(<span class="hljs-params">ERC165, IERC165</span>) <span class="hljs-title">returns</span> (<span class="hljs-params">bool</span>) </span>{
...
<p>ERC165的目的-一种发布和检测智能合约实现的接口的标准。</p>
<p>防止用户传递给接口的地址是无效的（如EOA地址），该协议会在合约内部做地址检查。</p>
                ...
                <a href="03_ERC1155.html" class="navigation navigation-prev " aria-label="Previous page: 第3节:ERC1155">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="05_ERC1820.html" class="navigation navigation-next " aria-label="Next page: 第5节:ERC1820">
