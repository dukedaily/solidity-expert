...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第三章:token协议 · HonKit</title>
    ...
    <link rel="next" href="01_ERC20.html" />
    
    
    <link rel="prev" href="../02_solidity进阶/24_最佳实践.html" />
        ...
        <a href=".." >第三章:token协议</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第三章：token协议"><a name="第三章：token协议" class="plugin-anchor" href="#第三章：token协议"><i class="fa fa-link" aria-hidden="true"></i></a>第三章：Token协议</h1>
<p>从本章开始，我们将从语法层面跳出来，开始关注协议相关内容，由于Token协议是我们日常接触最多的落地应用，所以我们从Token合约入手。</p>
<p>我们将介绍主流的协议，包括：</p>
<ul>
<li>ERC20，这是标准的代笔协议，本质上就是一个solidity合约，代表协议如：USDT，WBTC等。</li>
<li>ERC721，这个就是我们所谓的NFT（Non-Fungible Token），加密猫，无聊猿等。</li>
<li>ERC1155，这是介于ERC20和ERC721之间的协议，属于半同质化合约协议（Semi Non-Fungible Token），它属于在Token层面是同质化，在Id层面是非同质化的Token</li>
<li>其他协议，待定</li>
</ul>
                ...
                <a href="../02_solidity进阶/24_最佳实践.html" class="navigation navigation-prev " aria-label="Previous page: 第24节:最佳实践">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="01_ERC20.html" class="navigation navigation-next " aria-label="Next page: 第1节:ERC20">
