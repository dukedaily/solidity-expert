...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第3节:ERC1155 · HonKit</title>
    ...
    <link rel="next" href="04_ERC165.html" />
    
    
    <link rel="prev" href="02_ERC721.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.8.3" data-path="03_ERC1155.html">
        ...
        <a href=".." >第3节:ERC1155</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第3节语法-erc1155"><a name="第3节语法-erc1155" class="plugin-anchor" href="#第3节语法-erc1155"><i class="fa fa-link" aria-hidden="true"></i></a>第3节:语法-ERC1155</h1>
<ol>
<li><p>1155是每个id为一个token组，每个组里面可以包含多个erc20</p>
</li>
<li><p>mint(to, id, amount)</p>
</li>
<li><p>setURI(id, uri)</p>
</li>
<li><p>setURI的时候，填写的是metadata.json，不是图片的url，使用pinata服务存储图片和metadata.json：</p>
<pre><code class="lang-js">{
    <span class="hljs-string">&quot;description&quot;</span>: <span class="hljs-string">&quot;this is a nft1155 metadata json desc&quot;</span>,
    <span class="hljs-comment">//&quot;image&quot;: &quot;ipfs://QmTfK2CeRBkRqSZHmnekdZYSBrsKLQ6U5Px8MWtGf1Eqta&quot;,</span>
...
<li><p>opensea测试网是rinkeby，链接为：<a href="https://testnets.opensea.io" target="_blank">https://testnets.opensea.io</a></p>
</li>
<li><p>opensea会自动将当前链接的地址账户的nft扫描出来展示在页面上。</p>
</li>
<li><p>自己部署（示例）：<a href="https://testnets.opensea.io/assets/rinkeby/0x54f1a0ad311e00b68fa940bc969c191863ac84fd/1" target="_blank">https://testnets.opensea.io/assets/rinkeby/0x54f1a0ad311e00b68fa940bc969c191863ac84fd/1</a></p>
</li>
</ol>
<h2 id="更好的合约："><a name="更好的合约：" class="plugin-anchor" href="#更好的合约："><i class="fa fa-link" aria-hidden="true"></i></a>更好的合约：</h2>
...
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;@openzeppelin/contracts/token/ERC1155/extensions/ERC1155URIStorage.sol&quot;</span>;
...
contract MockErc1155Token is ERC1155URIStorage {
    ...
    <span class="hljs-title">constructor</span>(<span class="hljs-params">string memory _name, string memory _symbol</span>) <span class="hljs-title">ERC1155</span>(<span class="hljs-params"><span class="hljs-string">&quot;&quot;</span></span>) {
        name = _name;
        symbol = _symbol;
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">createCollectible</span>(<span class="hljs-params">string memory tokenURI, uint256 _amount</span>)
        <span class="hljs-title">external</span>
        <span class="hljs-title">returns</span> (<span class="hljs-params">uint256</span>)
    </span>{
        uint256 newItemId = tokenCounter;
        _mint(_msgSender(), newItemId, _amount, <span class="hljs-string">&quot;&quot;</span>);
    ...
    <span class="hljs-comment">// function mint(uint256 _id, uint256 _amount) external {</span>
    <span class="hljs-comment">//     _mint(_msgSender(), _id, _amount, &quot;&quot;);</span>
    <span class="hljs-comment">// }</span>

    <span class="hljs-comment">// function mintBatch(uint256[] memory _ids, uint256[] memory _amounts)</span>
    <span class="hljs-comment">//     external</span>
    <span class="hljs-comment">// {</span>
    <span class="hljs-comment">//     _mintBatch(_msgSender(), _ids, _amounts, &quot;&quot;);</span>
    <span class="hljs-comment">// }</span>

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">burn</span>(<span class="hljs-params">uint256 _id, uint256 _amount</span>) <span class="hljs-title">external</span> </span>{
        _burn(msg.sender, _id, _amount);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">burnBatch</span>(<span class="hljs-params">uint256[] memory _ids, uint256[] memory _amounts</span>)
        <span class="hljs-title">external</span>
    </span>{
        _burnBatch(msg.sender, _ids, _amounts);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">burnForMint</span>(<span class="hljs-params">
        address _from,
        ...
        _mintBatch(_from, _mintIds, _mintAmounts, <span class="hljs-string">&quot;&quot;</span>);
    }

    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">setURI</span>(<span class="hljs-params">uint256 _id, string memory _uri</span>) <span class="hljs-title">external</span> </span>{
        _setURI(_id, _uri);
    }
}
</code></pre>
                ...
                <a href="02_ERC721.html" class="navigation navigation-prev " aria-label="Previous page: 第2节:ERC721">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="04_ERC165.html" class="navigation navigation-next " aria-label="Next page: 第4节:ERC165">
