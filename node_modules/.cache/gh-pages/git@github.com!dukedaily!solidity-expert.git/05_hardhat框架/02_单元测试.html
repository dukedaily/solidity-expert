...
<html lang="" >
    ...
    <link rel="next" href="03_fork主网.html" />
    
    
    <link rel="prev" href="01_QuickStart.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.10.2" data-path="02_单元测试.html">
        ...
        <a href=".." >第2节:单元测试</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第2节：单元测试"><a name="第2节：单元测试" class="plugin-anchor" href="#第2节：单元测试"><i class="fa fa-link" aria-hidden="true"></i></a>第2节：单元测试</h1>
<p>涉及到revertedWith时，需要：</p>
<ol>
<li><p>将await写在expect外面，里面不需要写await了</p>
</li>
<li><p>.to.revertedWith，不是.be.revertedWith，.to.be没试过</p>
<pre><code class="lang-sh">    describe(<span class="hljs-string">&apos;Create Offer&apos;</span>, () =&gt; {
        it.only(<span class="hljs-string">&apos;should faild to call createOffer directly&apos;</span>, async () =&gt; {
            <span class="hljs-built_in">let</span> last = await getOffer(lastOffer)
            await expect(last.createOffer(tokens, info)).to.revertedWith(<span class="hljs-string">&quot;Bazaar: permission denied&quot;</span>)
        })
    })
</code></pre>
</li>
<li><p>测试单个文件</p>
<pre><code class="lang-sh">npx hardhat <span class="hljs-built_in">test</span> <span class="hljs-built_in">test</span>/xxx.spec.ts
</code></pre>
</li>
<li><p>可以使用命令行将参数传递给命令行</p>
<pre><code class="lang-sh">FORK=<span class="hljs-literal">true</span> npx hardhat <span class="hljs-built_in">test</span> <span class="hljs-built_in">test</span>/xxx.spec.ts
</code></pre>
</li>
<li><p>单元测试使用fork</p>
<pre><code class="lang-js"><span class="hljs-comment">/* eslint-disable no-console */</span>
<span class="hljs-keyword">import</span> { network, ethers, waffle } <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;hardhat&apos;</span>
<span class="hljs-keyword">import</span> { Signer } <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;ethers&apos;</span>
<span class="hljs-comment">// import { SignerWithAddress } from &apos;@nomiclabs/hardhat-ethers/signers&apos;</span>
<span class="hljs-keyword">import</span> { JsonRpcServer } <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;hardhat/types&apos;</span>
<span class="hljs-keyword">import</span> { SignerWithAddress } <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;@nomiclabs/hardhat-ethers/signers&apos;</span>
<span class="hljs-keyword">import</span> { JsonRpcSigner } <span class="hljs-keyword">from</span> <span class="hljs-string">&apos;@ethersproject/providers&apos;</span>

<span class="hljs-built_in">console</span>.log(<span class="hljs-string">&apos;begin&apos;</span>)
describe(<span class="hljs-string">&apos;Send Transaction test&apos;</span>, <span class="hljs-function">() =&gt;</span> {
    <span class="hljs-keyword">let</span> signer: JsonRpcSigner
    <span class="hljs-keyword">let</span> acc0: SignerWithAddress

    beforeEach(<span class="hljs-keyword">async</span> () =&gt; {
        <span class="hljs-comment">// https://etherscan.io/accounts</span>
        <span class="hljs-keyword">const</span> ETHWHALE = <span class="hljs-string">&apos;0xF977814e90dA44bFA03b6295A0616a897441aceC&apos;</span>
        <span class="hljs-keyword">await</span> network.provider.request({
            ...
            <span class="hljs-attr">params</span>: [ETHWHALE]
        })

        <span class="hljs-keyword">const</span> accounts = <span class="hljs-keyword">await</span> ethers.getSigners()
        acc0 = accounts[<span class="hljs-number">0</span>]
        <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&apos;acc0:&apos;</span>, acc0.address)

        <span class="hljs-keyword">const</span> bal = <span class="hljs-keyword">await</span> ethers.provider.getBalance(acc0.address)
        <span class="hljs-comment">// default balance: 10000000000000000000000, this is defined in &apos;test-wallets.js&apos;</span>
    ...
    describe(<span class="hljs-string">&apos;sendTransaction Test&apos;</span>, <span class="hljs-function">() =&gt;</span> {
        it(<span class="hljs-string">&apos;should send transaction&apos;</span>, <span class="hljs-keyword">async</span> () =&gt; {
            ...
            <span class="hljs-keyword">const</span> bal = <span class="hljs-keyword">await</span> ethers.provider.getBalance(acc0.address)
            <span class="hljs-comment">// Result: 10020000000000000000000</span>
            <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&apos;new acc0 bal:&apos;</span>, bal.toString())
                ...
                <a href="01_QuickStart.html" class="navigation navigation-prev " aria-label="Previous page: 第1节:QuickStart">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="03_fork主网.html" class="navigation navigation-next " aria-label="Next page: 第3节:fork主网">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第2节:单元测试","level":"1.10.2","depth":2,"next":{"title":"第3节:fork主网","level":"1.10.3","depth":2,"path":"05_hardhat框架/03_fork主网.md","ref":"05_hardhat框架/03_fork主网.md","articles":[]},"previous":{"title":"第1节:QuickStart","level":"1.10.1","depth":2,"path":"05_hardhat框架/01_QuickStart.md","ref":"05_hardhat框架/01_QuickStart.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"05_hardhat框架/02_单元测试.md","mtime":"2022-09-16T03:19:14.000Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
