...
<html lang="" >
    ...
    <link rel="next" href="04_多版本编译.html" />
    
    
    <link rel="prev" href="02_单元测试.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.10.3" data-path="03_fork主网.html">
        ...
        <a href=".." >第3节:fork主网</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <p>参考链接：<a href="https://blog.csdn.net/weixin_43840202/article/details/121114097" target="_blank">https://blog.csdn.net/weixin_43840202/article/details/121114097</a></p>
<p>impersonate_account:</p>
<pre><code class="lang-js"><span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">f1</span>(<span class="hljs-params"></span>)</span>{
  <span class="hljs-keyword">await</span> hardhat.network.provider.request({
    <span class="hljs-attr">method</span>: <span class="hljs-string">&quot;hardhat_impersonateAccount&quot;</span>,
    <span class="hljs-attr">params</span>: [被模拟的账户],
  });
  <span class="hljs-keyword">const</span> signer = <span class="hljs-keyword">await</span> ethers.provider.getSigner(被模拟的账户)
  <span class="hljs-comment">// 用模拟的账户给指定账户转账</span>
  <span class="hljs-keyword">await</span> signer.sendTransaction({
    <span class="hljs-attr">to</span>: <span class="hljs-string">&quot;0x23FCB0E1DDbC821Bd26D5429BA13B7D5c96C0DE0&quot;</span>,
    <span class="hljs-attr">value</span>: ethers.utils.parseEther(<span class="hljs-string">&quot;1.0&quot;</span>),
  });
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&apos;success&apos;</span>)

<span class="hljs-comment">// 取消模拟</span>
  <span class="hljs-keyword">await</span> hardhat.network.provider.request({
    <span class="hljs-attr">method</span>: <span class="hljs-string">&quot;hardhat_stopImpersonatingAccount&quot;</span>,
    <span class="hljs-attr">params</span>: [被模拟的账户],
  });
}

f1().then(<span class="hljs-function">() =&gt;</span> process.exit(<span class="hljs-number">0</span>))
...
main().catch(<span class="hljs-function">(<span class="hljs-params">error</span>) =&gt;</span> {
    ...
    process.exitCode = <span class="hljs-number">1</span>;
                ...
                <a href="02_单元测试.html" class="navigation navigation-prev " aria-label="Previous page: 第2节:单元测试">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="04_多版本编译.html" class="navigation navigation-next " aria-label="Next page: 第4节:多版本编译">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第3节:fork主网","level":"1.10.3","depth":2,"next":{"title":"第4节:多版本编译","level":"1.10.4","depth":2,"path":"05_hardhat框架/04_多版本编译.md","ref":"05_hardhat框架/04_多版本编译.md","articles":[]},"previous":{"title":"第2节:单元测试","level":"1.10.2","depth":2,"path":"05_hardhat框架/02_单元测试.md","ref":"05_hardhat框架/02_单元测试.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"05_hardhat框架/03_fork主网.md","mtime":"2022-10-04T06:35:34.182Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
