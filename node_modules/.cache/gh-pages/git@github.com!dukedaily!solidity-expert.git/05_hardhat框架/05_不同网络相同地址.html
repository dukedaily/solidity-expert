...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第5节:不同网络相同地址 · HonKit</title>
    ...
    <link rel="next" href="06_部署fork_graphnode_subgraph.html" />
    
    
    <link rel="prev" href="04_多版本编译.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.10.5" data-path="05_不同网络相同地址.html">
        ...
        <a href=".." >第5节:不同网络相同地址</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第1节多链部署相同地址"><a name="第1节多链部署相同地址" class="plugin-anchor" href="#第1节多链部署相同地址"><i class="fa fa-link" aria-hidden="true"></i></a>第1节:多链部署相同地址</h1>
<p>不同网络部署相同的地址：<a href="https://www.npmjs.com/package/xdeployer" target="_blank">xdeployer</a>，每次执行只能部署一个合约。</p>
<ol>
<li><p>安装插件</p>
<pre><code class="lang-js">npm install --save-dev xdeployer
</code></pre>
</li>
<li><p>hardhat.config.ts中增加：</p>
<pre><code class="lang-js"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;xdeployer&quot;</span>;
</code></pre>
</li>
<li><p>增加配置</p>
<pre><code class="lang-js">    xdeploy: {
        <span class="hljs-attr">contract</span>: <span class="hljs-string">&quot;Mock1Inch&quot;</span>,
        <span class="hljs-comment">//constructorArgsPath: &quot;&quot;,</span>
        <span class="hljs-attr">constructorArgsPath</span>: <span class="hljs-string">&quot;./deploy-args.ts&quot;</span>,
        <span class="hljs-attr">salt</span>: <span class="hljs-string">&quot;Bydefi&quot;</span>,
        <span class="hljs-attr">signer</span>: process.env.PRIVATE_KEY,
        <span class="hljs-attr">networks</span>: [<span class="hljs-string">&quot;hardhat&quot;</span>, <span class="hljs-string">&quot;ropsten&quot;</span>],
        <span class="hljs-attr">rpcUrls</span>: [<span class="hljs-string">&quot;hardhat&quot;</span>, NETWORKS_RPC_URL[<span class="hljs-string">&quot;ropsten&quot;</span>]],
        <span class="hljs-attr">gasLimit</span>: DEFAULT_BLOCK_GAS_LIMIT
    },
...
<li><p>构造函数的格式：./deploy-args.ts</p>
<pre><code class="lang-js"><span class="hljs-keyword">const</span> data = [
  <span class="hljs-string">&quot;arg1&quot;</span>,
  <span class="hljs-string">&quot;arg2&quot;</span>,
  ...
];

<span class="hljs-keyword">export</span> { data };
</code></pre>
</li>
<li><p>增加contracts/Create2DeployerLocal.sol</p>
...
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;xdeployer/src/contracts/Create2Deployer.sol&quot;</span>;

contract Create2DeployerLocal is Create2Deployer {}
</code></pre>
</li>
<li><p>执行部署命令：</p>
<pre><code class="lang-sh">npx hardhat xdeploy
</code></pre>
</li>
<li><p>支持的网络</p>
<pre><code class="lang-sh">localhost,hardhat,rinkeby,ropsten,kovan,goerli,sepolia,bscTestnet,optimismTestnet,arbitrumTestnet,mumbai,hecoTestnet,fantomTestnet,fuji,sokol,moonbaseAlpha,alfajores,auroraTestnet,harmonyTestnet,spark,cronosTestnet,ethMain,bscMain,optimismMain,arbitrumMain,polygon,hecoMain,fantomMain,avalanche,gnosis,moonriver,moonbeam,celo,auroraMain,harmonyMain,autobahn,fuse,cronos.
</code></pre>
</li>
</ol>
<h1 id="原理"><a name="原理" class="plugin-anchor" href="#原理"><i class="fa fa-link" aria-hidden="true"></i></a>原理</h1>
<p>研究一下这个合约代码：<a href="https://bscscan.com/address/0x13b0d85ccb8bf860b6b79af3029fca081ae9bef2" target="_blank">https://bscscan.com/address/0x13b0d85ccb8bf860b6b79af3029fca081ae9bef2</a></p>
<p>目前在bsc主网可以正常部署，但是arbitrium上部署失败，我是通过参考bsc合约的deploy参数，在arbi上手动调用的deploy，也完成 合约的部署和verify。</p>
<h1 id="手动地址"><a name="手动地址" class="plugin-anchor" href="#手动地址"><i class="fa fa-link" aria-hidden="true"></i></a>手动地址</h1>
<p>xdeployer地址：0x13b0d85ccb8bf860b6b79af3029fca081ae9bef2</p>
<ol>
<li>找到这个地址</li>
<li>调用deploy方法：</li>
</ol>
                ...
                <a href="04_多版本编译.html" class="navigation navigation-prev " aria-label="Previous page: 第4节:多版本编译">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="06_部署fork_graphnode_subgraph.html" class="navigation navigation-next " aria-label="Next page: 第6节:graphnode-subgraph">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第5节:不同网络相同地址","level":"1.10.5","depth":2,"next":{"title":"第6节:graphnode-subgraph","level":"1.10.6","depth":2,"path":"05_hardhat框架/06_部署fork_graphnode_subgraph.md","ref":"05_hardhat框架/06_部署fork_graphnode_subgraph.md","articles":[]},"previous":{"title":"第4节:多版本编译","level":"1.10.4","depth":2,"path":"05_hardhat框架/04_多版本编译.md","ref":"05_hardhat框架/04_多版本编译.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"05_hardhat框架/05_不同网络相同地址.md","mtime":"2022-09-16T03:19:14.911Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
