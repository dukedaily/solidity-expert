...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第1节:QuickStart · HonKit</title>
    ...
    <link rel="next" href="02_单元测试.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.10.1" data-path="01_QuickStart.html">
        ...
        <li class="chapter " data-level="1.10.6" data-path="06_部署fork_graphnode_subgraph.html">
        ...
        <a href=".." >第1节:QuickStart</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第一节：快速体验quickstart"><a name="第一节：快速体验quickstart" class="plugin-anchor" href="#第一节：快速体验quickstart"><i class="fa fa-link" aria-hidden="true"></i></a>第一节：快速体验QuickStart</h1>
<p>实用命令：</p>
<pre><code class="lang-sh"><span class="hljs-comment">## hh</span>
npm install --global hardhat-shorthand

<span class="hljs-comment"># 查看支持的网络</span>
npx hardhat verify --list-networks
</code></pre>
<h2 id="环境构造"><a name="环境构造" class="plugin-anchor" href="#环境构造"><i class="fa fa-link" aria-hidden="true"></i></a>环境构造</h2>
<pre><code class="lang-sh"><span class="hljs-comment">#创建npm空项目</span>
npm init 
...
<span class="hljs-comment">#运行测试（默认已经不支持）</span>
...
<li>scripts：脚本</li>
<li>test：单元测试</li>
<li>hardhat.config.ts：配置文件</li>
<li>package.json：包管理文件</li>
</ul>
<h2 id="hardhat-toolbox"><a name="hardhat-toolbox" class="plugin-anchor" href="#hardhat-toolbox"><i class="fa fa-link" aria-hidden="true"></i></a>hardhat-toolbox</h2>
<p>当前版本：hardhat：^2.11.1，在配置文件中，引用了hardhat-toolbox包，这是一个集合，安装了常用的npm包。</p>
<pre><code class="lang-js"><span class="hljs-keyword">import</span> { HardhatUserConfig } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;hardhat/config&quot;</span>;
...
<li><p>修改.env</p>
<ul>
<li><p>rpc: alchemy（更快）：</p>
</li>
<li><p>rpc: infura：小狐狸使用的，以太坊基金会赞助：</p>
</li>
</ul>
<pre><code class="lang-sh">ETHERSCAN_API_KEY=
ALCHEMY_KEY=
INFURA_KEY=
PRIVATE_KEY=
</code></pre>
...
<li><p>配置文件完整内容：</p>
<pre><code class="lang-ts"><span class="hljs-keyword">import</span> { HardhatUserConfig } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;hardhat/config&quot;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;@nomicfoundation/hardhat-toolbox&quot;</span>;
<span class="hljs-comment">// import * as dotenv from &quot;dotenv&quot;;</span>
<span class="hljs-built_in">require</span>(<span class="hljs-string">&apos;dotenv&apos;</span>).config()

<span class="hljs-keyword">const</span> PRIVATE_KEY = process.env.PRIVATE_KEY || <span class="hljs-string">&apos;&apos;</span>
<span class="hljs-keyword">const</span> ALCHEMY_KEY = process.env.ALCHEMY_KEY || <span class="hljs-string">&apos;&apos;</span>
<span class="hljs-keyword">const</span> INFURA_KEY = process.env.INFURA_KEY || <span class="hljs-string">&apos;&apos;</span>
<span class="hljs-keyword">const</span> ETHERSCAN_API_KEY = process.env.ETHERSCAN_API_KEY || <span class="hljs-string">&apos;&apos;</span>

<span class="hljs-built_in">console</span>.log(<span class="hljs-string">&quot;PRIVATE_KEY: &quot;</span>, PRIVATE_KEY);
<span class="hljs-built_in">console</span>.log(<span class="hljs-string">&quot;ALCHEMY_KEY: &quot;</span>, ALCHEMY_KEY);
...
<span class="hljs-keyword">const</span> config: HardhatUserConfig = {
    <span class="hljs-attr">networks</span>: {
        ...
        <span class="hljs-attr">mainnet</span>: {
            <span class="hljs-attr">url</span>: <span class="hljs-string">`https://eth-mainnet.g.alchemy.com/v2/<span class="hljs-subst">${ALCHEMY_KEY}</span>`</span>,
            <span class="hljs-attr">accounts</span>: [PRIVATE_KEY]
        },
        <span class="hljs-attr">kovan</span>: {
            <span class="hljs-comment">// url: `https://eth-kovan.g.alchemy.com/v2/${ALCHEMY_KEY}`,</span>
        ...
        <span class="hljs-attr">ropsten</span>: {
            <span class="hljs-comment">// url: `https://eth-kovan.g.alchemy.com/v2/${ALCHEMY_KEY}`,</span>
            <span class="hljs-attr">url</span>: <span class="hljs-string">`https://ropsten.infura.io/v3/<span class="hljs-subst">${INFURA_KEY}</span>`</span>,
            <span class="hljs-attr">accounts</span>: [PRIVATE_KEY]
        }
    },
    ...
    <span class="hljs-attr">etherscan</span>: {
        <span class="hljs-attr">apiKey</span>: {
          <span class="hljs-attr">ropsten</span>: ETHERSCAN_API_KEY
        }
      }
};
...
<ol>
<li><p>部署不同网络</p>
<pre><code class="lang-js">npx hardhat run scripts/deploy.ts --network ropsten
</code></pre>
</li>
<li><p>Verify</p>
<pre><code class="lang-sh"><span class="hljs-comment">#https://ropsten.etherscan.io/address/0x61c8E000634154dF38B2ec23483fa2E08984d938#code</span>
...
<ol>
<li>hardhat手册：<a href="https://hardhat.org/hardhat-runner/docs/getting-started#overview" target="_blank">https://hardhat.org/hardhat-runner/docs/getting-started#overview</a></li>
<li>alchemy：<a href="https://dashboard.alchemy.com/apps" target="_blank">https://dashboard.alchemy.com/apps</a></li>
<li>infura：<a href="https://infura.io/" target="_blank">https://infura.io/</a></li>
</ol>
                ...
                <a href="./" class="navigation navigation-prev " aria-label="Previous page: 第五章:hardhat框架">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="02_单元测试.html" class="navigation navigation-next " aria-label="Next page: 第2节:单元测试">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第1节:QuickStart","level":"1.10.1","depth":2,"next":{"title":"第2节:单元测试","level":"1.10.2","depth":2,"path":"05_hardhat框架/02_单元测试.md","ref":"05_hardhat框架/02_单元测试.md","articles":[]},"previous":{"title":"第五章:hardhat框架","level":"1.10","depth":1,"path":"05_hardhat框架/README.md","ref":"05_hardhat框架/README.md","articles":[{"title":"第1节:QuickStart","level":"1.10.1","depth":2,"path":"05_hardhat框架/01_QuickStart.md","ref":"05_hardhat框架/01_QuickStart.md","articles":[]},{"title":"第2节:单元测试","level":"1.10.2","depth":2,"path":"05_hardhat框架/02_单元测试.md","ref":"05_hardhat框架/02_单元测试.md","articles":[]},{"title":"第3节:fork主网","level":"1.10.3","depth":2,"path":"05_hardhat框架/03_fork主网.md","ref":"05_hardhat框架/03_fork主网.md","articles":[]},{"title":"第4节:多版本编译","level":"1.10.4","depth":2,"path":"05_hardhat框架/04_多版本编译.md","ref":"05_hardhat框架/04_多版本编译.md","articles":[]},{"title":"第5节:不同网络相同地址","level":"1.10.5","depth":2,"path":"05_hardhat框架/05_不同网络相同地址.md","ref":"05_hardhat框架/05_不同网络相同地址.md","articles":[]},{"title":"第6节:graphnode-subgraph","level":"1.10.6","depth":2,"path":"05_hardhat框架/06_部署fork_graphnode_subgraph.md","ref":"05_hardhat框架/06_部署fork_graphnode_subgraph.md","articles":[]},{"title":"第7节:07_综合教程","level":"1.10.7","depth":2,"path":"05_hardhat框架/07_综合教程.md","ref":"05_hardhat框架/07_综合教程.md","articles":[]},{"title":"第8节:合约升级","level":"1.10.8","depth":2,"path":"05_hardhat框架/08_合约升级.md","ref":"05_hardhat框架/08_合约升级.md","articles":[]}]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"05_hardhat框架/01_QuickStart.md","mtime":"2022-10-18T23:21:29.602Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
