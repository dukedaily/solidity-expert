...
<html lang="" >
    ...
    <link rel="next" href="05_不同网络相同地址.html" />
    
    
    <link rel="prev" href="03_fork主网.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.10.4" data-path="04_多版本编译.html">
        ...
        <a href=".." >第4节:多版本编译</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <ol>
<li><p>解决多版本编译：<a href="https://hardhat.org/hardhat-runner/docs/advanced/multiple-solidity-versions" target="_blank">https://hardhat.org/hardhat-runner/docs/advanced/multiple-solidity-versions</a></p>
<p>如果指定多个版本，当合约中未指定明确版本时，hardhat会默认使用最高的版本编译，此时会出现问题；解决办法是对特定的文件明确编译器版本号，即下文中的overrides部分：</p>
<pre><code class="lang-js">solidity: {
        <span class="hljs-attr">overrides</span>: {
            <span class="hljs-string">&apos;@uniswap/v3-core/contracts/libraries/FullMath.sol&apos;</span>: {
                <span class="hljs-attr">version</span>: <span class="hljs-string">&apos;0.7.6&apos;</span>
            },
            <span class="hljs-string">&apos;@uniswap/v3-core/contracts/libraries/TickMath.sol&apos;</span>: {
                <span class="hljs-attr">version</span>: <span class="hljs-string">&apos;0.7.6&apos;</span>
            }
        },
        <span class="hljs-attr">compilers</span>: [
            {
                <span class="hljs-attr">version</span>: <span class="hljs-string">&apos;0.8.10&apos;</span>,
            ...
            {
                <span class="hljs-attr">version</span>: <span class="hljs-string">&apos;0.6.12&apos;</span>
            }
        ]
    },
</code></pre>
                ...
                <a href="03_fork主网.html" class="navigation navigation-prev " aria-label="Previous page: 第3节:fork主网">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="05_不同网络相同地址.html" class="navigation navigation-next " aria-label="Next page: 第5节:不同网络相同地址">
