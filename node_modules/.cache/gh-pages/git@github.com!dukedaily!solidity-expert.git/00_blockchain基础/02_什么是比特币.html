...
<html lang="" >
    ...
    <link rel="next" href="03_什么是以太坊.html" />
    
    
    <link rel="prev" href="01_什么是区块链.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.5.2" data-path="02_什么是比特币.html">
        ...
        <a href=".." >第2节:什么是比特币</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第2节：什么是比特币"><a name="第2节：什么是比特币" class="plugin-anchor" href="#第2节：什么是比特币"><i class="fa fa-link" aria-hidden="true"></i></a>第2节：什么是比特币</h1>
<p>我2012年时第一次听说比特币，2018年开始给别人讲什么是比特币，2022年却依然没持有比特币，单从这一点上，我觉得我是个纯粹的人，一个有益于人民的人，一个脱离了低级趣味的人[狗头]。</p>
<h2 id="比特币"><a name="比特币" class="plugin-anchor" href="#比特币"><i class="fa fa-link" aria-hidden="true"></i></a>比特币</h2>
<p>还是要说说比特币，它诞生于2009年，最初是C++实现的，它的功能非常纯粹：就是用来转账的，基本没法在上面做二次开发，比如想自己基于比特币开发一个DAPP（去中心化应用），这个是不可能的。</p>
<p><img src="assets/btc.png" alt="btc"></p>
<p>这也是为什么后来会出现以太坊这个区块链项目，以太坊的存在弥补了比特币无法二次开发的问题，不过这也是中本聪（比特币的创造者）的本意，咱不搞那些花里胡哨的功能，聚焦金融，安全稳定。</p>
<p>比特币的具体原理过于复杂，无法在这里展开来介绍，下面👇有个开源仓库，可以到那里去学习。</p>
<h2 id="在线demo"><a name="在线demo" class="plugin-anchor" href="#在线demo"><i class="fa fa-link" aria-hidden="true"></i></a>在线Demo</h2>
<p>这是一个老外开发录制的比特币可视化demo，生动的描述了比特币的诸多基本概念，建议看一下视频，然后体验一下</p>
...
<p>自己体验：<a href="https://andersbrownworth.com/blockchain" target="_blank">https://andersbrownworth.com/blockchain</a></p>
<p>比特币公式算法（工作量证明，POW）挖矿逻辑，如下图：</p>
<p><img src="assets/pow挖矿逻辑.png" alt="pow挖矿逻辑"></p>
<h2 id="我的仓库"><a name="我的仓库" class="plugin-anchor" href="#我的仓库"><i class="fa fa-link" aria-hidden="true"></i></a>我的仓库</h2>
<p>如果想系统的了解比特币的具体原理，可以移步我的另一个开源项目：<a href="https://github.com/dukedaily/go-bitcoin-demo" target="_blank">go-bitcoin-demo</a>，里面是2018年6月份的授课内容，5天课程，属于夯实web3基本功必修课，全套资料奉上（视频、教程、代码，嘴对嘴教学）。</p>
<p>以下为课程介绍，后续内容会陆续上传，请关注我的个人B站账号：<strong>杜旭duke</strong></p>
...
<p>比特币是永远的神，在币圈一般都称之为：大饼，各种牛鬼蛇神币种的涨跌基本完全看大饼的脸色，大饼每四年减产一次（即挖矿的奖励减半），大约在2140年时会全部挖完（2100w枚），届时就是另外一个世界了，你我应该看不着了。</p>
<p>我们的重心是以太坊开发，所以比特币部分就做个简短的介绍，比特币总量计算如下：</p>
<pre><code class="lang-go"><span class="hljs-keyword">package</span> main

<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;fmt&quot;</span>

<span class="hljs-function"><span class="hljs-keyword">func</span> <span class="hljs-title">main</span><span class="hljs-params">()</span></span> {
    total := <span class="hljs-number">0.0</span>     <span class="hljs-comment">//总量</span>
    interval := <span class="hljs-number">21.0</span> <span class="hljs-comment">//区块间隔，万单位</span>

    reward := <span class="hljs-number">50.0</span> <span class="hljs-comment">//奖励数量，最初50个</span>

    <span class="hljs-keyword">for</span> reward != <span class="hljs-number">0</span> {
        <span class="hljs-comment">//累加挖矿值</span>
        amount := reward * interval

        total += amount <span class="hljs-comment">//总量</span>

        reward *= <span class="hljs-number">0.5</span> <span class="hljs-comment">//奖励减半</span>
    }

    fmt.Println(<span class="hljs-string">&quot;total : &quot;</span>, total)
    fmt.Printf(<span class="hljs-string">&quot;total : %f\n&quot;</span>, total)
}
</code></pre>
...
<p>关于作者：国内第一批区块链布道者；2017年开始专注于区块链教育(btc, eth, fabric)，目前base新加坡，专注海外defi,dex,元宇宙等业务方向。</p>
                ...
                <a href="01_什么是区块链.html" class="navigation navigation-prev " aria-label="Previous page: 第1节:什么是区块链">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="03_什么是以太坊.html" class="navigation navigation-next " aria-label="Next page: 第3节:什么是以太坊">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第2节:什么是比特币","level":"1.5.2","depth":2,"next":{"title":"第3节:什么是以太坊","level":"1.5.3","depth":2,"path":"00_blockchain基础/03_什么是以太坊.md","ref":"00_blockchain基础/03_什么是以太坊.md","articles":[]},"previous":{"title":"第1节:什么是区块链","level":"1.5.1","depth":2,"path":"00_blockchain基础/01_什么是区块链.md","ref":"00_blockchain基础/01_什么是区块链.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"00_blockchain基础/02_什么是比特币.md","mtime":"2022-11-02T05:30:26.000Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
