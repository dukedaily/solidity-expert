...
<html lang="" >
    <head>
        <meta charset="UTF-8">
        <title>第10节:solidity岗位要求 · HonKit</title>
    ...
    <link rel="next" href="11_rpc节点.html" />
    
    
    <link rel="prev" href="09_区块链就业.html" />
...
<ul class="summary">
        ...
        <li class="chapter active" data-level="1.5.10" data-path="10_solidity岗位要求.html">
        ...
        <a href=".." >第10节:solidity岗位要求</a>
                    ...
                    <div class="page-wrapper" tabindex="-1" role="main">
                        <div class="page-inner">
                                ...
                                <h1 id="第10节：solidity岗位要求"><a name="第10节：solidity岗位要求" class="plugin-anchor" href="#第10节：solidity岗位要求"><i class="fa fa-link" aria-hidden="true"></i></a>第10节：solidity岗位要求</h1>
<p>以下是网上招聘需求的汇总，仅供参考。初级：语法、中高级：语法+协议、专家：语法+协议+上下游技术栈</p>
<h2 id="初级"><a name="初级" class="plugin-anchor" href="#初级"><i class="fa fa-link" aria-hidden="true"></i></a>初级</h2>
<pre><code class="lang-js">区块链生态研发工程师
...
<h2 id="中高级："><a name="中高级：" class="plugin-anchor" href="#中高级："><i class="fa fa-link" aria-hidden="true"></i></a>中高级：</h2>
<pre><code class="lang-js">如何成为一名合格的智能合约高级工程师：
<span class="hljs-number">1</span>、熟悉 Solidity 语言，能使用 hardhat 完成智能合约的自动化测试、优化、部署、交互和 SDK 封装。
<span class="hljs-number">2</span>、熟悉 Openzipplin 的所有库文件，能够完成可升级合约的部署和升级。
<span class="hljs-number">3</span>、熟悉市面上主流的智能合约项目的实现：dex、lend、skating、oracle、bridge（每种至少两个）
<span class="hljs-number">4</span>、熟悉内联汇编，清楚智能合约执行过程的 GAS 消耗，能对智能合约做最大程度的 GAS 优化。
<span class="hljs-number">5</span>、熟悉主流的 EIP 标准，跟进 EIP 提案的进度，能撰写新提案的分析。
<span class="hljs-number">6</span>、熟悉 Solidity 各个版本之间的区别，能跟进 Solidity 版本更新。
<span class="hljs-number">7</span>、熟悉 Solidity 编译成字节码的步骤，能使用字节码反推出智能合约的执行步骤。
<span class="hljs-number">8</span>、熟悉智能合约在 EVM 上执行的原理，能对区块链做 EVM 兼容。
<span class="hljs-number">9</span>、熟悉其他主流的智能合约语言和机制（比如 rust 和 move）。
</code></pre>
<h2 id="expert"><a name="expert" class="plugin-anchor" href="#expert"><i class="fa fa-link" aria-hidden="true"></i></a>Expert</h2>
<pre><code class="lang-sh">What is your responsibility?
1. Implement EVM-based smart contracts
2. Review EVM-based smart contracts and audit <span class="hljs-keyword">for</span> security issues
...
6. Proactively make suggestions <span class="hljs-keyword">for</span> improving our products and internal processes

What are the requirements?
1. You are an expert <span class="hljs-keyword">in</span> smart contracts and Solidity
2. You have a deep understanding of the EVM and understand smart contracts down to the opcode-level
3. You are familiar with the <span class="hljs-built_in">source</span> code of at least one Ethereum node implementation
4. You have a strong understanding of JavaScript fundamentals, modern tooling, and ecosystem
5. You are proficient <span class="hljs-keyword">in</span> using web3.js and ethers.js libraries
...
3. You have considered and feel comfortable, or have experience working <span class="hljs-keyword">in</span> a startup environment
</code></pre>
<h2 id="expert"><a name="expert" class="plugin-anchor" href="#expert"><i class="fa fa-link" aria-hidden="true"></i></a>Expert</h2>
<pre><code class="lang-js">You are:
● A proven Solidity dev <span class="hljs-keyword">with</span> <span class="hljs-number">2</span>+ years <span class="hljs-keyword">of</span> experience building prominent products <span class="hljs-keyword">in</span> the DeFi space
● Deep understanding <span class="hljs-keyword">of</span> DeFi, decentralized protocols, DAOs, cryptocurrencies and blockchain <span class="hljs-keyword">in</span> general and EVM
● Experience <span class="hljs-keyword">with</span> web3 frameworks and interfacing <span class="hljs-keyword">with</span> Ethereum nodes and services (Geth, Hardhat, Alchemy, Infura, Tenderly, etc.)
● Experience <span class="hljs-keyword">in</span> deploying complex systems to Ethereum
● Fast learner and independent
● Ability to work and communicate efficiently remotely

Nice To Have
● Graduate <span class="hljs-keyword">in</span> computer science, math or engineering
● Experience <span class="hljs-keyword">in</span> implementing complex math <span class="hljs-keyword">with</span> smart contract constraints

You will:
● Participate <span class="hljs-keyword">in</span> the entire development lifecycle, focusing on design, coding and debugging
● Build reusable code and libraries <span class="hljs-keyword">for</span> future use
● Optimize the application <span class="hljs-keyword">for</span> performance and scalability
● Implement security and data access
● Provide clean API <span class="hljs-keyword">for</span> different clients
</code></pre>
                ...
                <a href="09_区块链就业.html" class="navigation navigation-prev " aria-label="Previous page: 第9节:区块链就业">
                    <i class="fa fa-angle-left"></i>
                </a>
                
                
                <a href="11_rpc节点.html" class="navigation navigation-next " aria-label="Next page: 第11节:rpc节点">
    ...
    <script>
        ...
        gitbook.push(function() {
            gitbook.page.hasChanged({"page":{"title":"第10节:solidity岗位要求","level":"1.5.10","depth":2,"next":{"title":"第11节:rpc节点","level":"1.5.11","depth":2,"path":"00_blockchain基础/11_rpc节点.md","ref":"00_blockchain基础/11_rpc节点.md","articles":[]},"previous":{"title":"第9节:区块链就业","level":"1.5.9","depth":2,"path":"00_blockchain基础/09_区块链就业.md","ref":"00_blockchain基础/09_区块链就业.md","articles":[]},"dir":"ltr"},"config":{"gitbook":"*","theme":"default","variables":{},"plugins":["-search","-lunr","toggle-chapters","page-toc-button","include-codeblock","anchors","js-console"],"pluginsConfig":{"toggle-chapters":{},"page-toc-button":{},"include-codeblock":{"check":false,"edit":false,"lang":"","fixlang":false,"template":"default","theme":"chrome","unindent":false},"anchors":{},"js-console":{},"highlight":{},"fontsettings":{"theme":"white","family":"sans","size":2},"theme-default":{"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"},"showLevel":false}},"structure":{"langs":"LANGS.md","readme":"README.md","glossary":"GLOSSARY.md","summary":"SUMMARY.md"},"pdf":{"pageNumbers":true,"fontSize":12,"fontFamily":"Arial","paperSize":"a4","chapterMark":"pagebreak","pageBreaksBefore":"/","margin":{"right":62,"left":62,"top":56,"bottom":56},"embedFonts":false},"styles":{"website":"styles/website.css","pdf":"styles/pdf.css","epub":"styles/epub.css","mobi":"styles/mobi.css","ebook":"styles/ebook.css","print":"styles/print.css"}},"file":{"path":"00_blockchain基础/10_solidity岗位要求.md","mtime":"2022-11-02T05:58:41.000Z","type":"markdown"},"gitbook":{"version":"3.7.3","time":"2022-11-17T14:36:53.165Z"},"basePath":"..","book":{"language":""}});
        });
    </script>
</div>
